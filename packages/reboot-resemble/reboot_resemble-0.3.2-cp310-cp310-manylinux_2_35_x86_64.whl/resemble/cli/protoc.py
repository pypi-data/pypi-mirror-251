...
async def protoc(
    ...
    with use_working_directory(args.working_directory, parser):
        ...
        # Add Resemble protos that need code-gen to the list of proto arguments.
        # All files added here should be included in //resemble/v1alpha1:protos.
        protoc_args.append("resemble/v1alpha1/tasks.proto")
