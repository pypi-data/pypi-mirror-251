...
class CustomObject(Generic[ProtoMessageT], metaclass=CustomObjectMeta):
    """
    CustomObject is intended to be a superclass of e.g. ServerConfig.
    It contains shared behavior for the Python proto wrappers where we define
    our system custom_resource_definitions.
    """
    # The k8s group and version associated with this custom object type.
    # If necessary, subclasses should reset these values to match their
    # definitions.
    # NOTE: These variables are class variables and not intended to be used as
    # instance variables, though the casing might suggest the opposite.
