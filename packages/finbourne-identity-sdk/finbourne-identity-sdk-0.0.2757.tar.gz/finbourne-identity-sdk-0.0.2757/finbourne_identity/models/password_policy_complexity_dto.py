...
class PasswordPolicyComplexityDto(object):
    ...
    def __init__(self, min_length=None, exclude_first_name=None, exclude_last_name=None, local_vars_configuration=None):  # noqa: E501
        """PasswordPolicyComplexityDto - a model defined in OpenAPI"
    ...
    @property
    def min_length(self):
        """Gets the min_length of this PasswordPolicyComplexityDto.  # noqa: E501

        The minimum length for a password  # noqa: E501

        :return: The min_length of this PasswordPolicyComplexityDto.  # noqa: E501
        :rtype: int
        """
    ...
    def min_length(self, min_length):
        """Sets the min_length of this PasswordPolicyComplexityDto.

        The minimum length for a password  # noqa: E501

        :param min_length: The min_length of this PasswordPolicyComplexityDto.  # noqa: E501
        :type min_length: int
        """
    ...
    def exclude_first_name(self):
        """Gets the exclude_first_name of this PasswordPolicyComplexityDto.  # noqa: E501

        Rule determining whether a user's first name should be permitted in their password  # noqa: E501

        :return: The exclude_first_name of this PasswordPolicyComplexityDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def exclude_first_name(self, exclude_first_name):
        """Sets the exclude_first_name of this PasswordPolicyComplexityDto.

        Rule determining whether a user's first name should be permitted in their password  # noqa: E501

        :param exclude_first_name: The exclude_first_name of this PasswordPolicyComplexityDto.  # noqa: E501
        :type exclude_first_name: bool
        """
    ...
    def exclude_last_name(self):
        """Gets the exclude_last_name of this PasswordPolicyComplexityDto.  # noqa: E501

        Rule determining whether a user's last name should be permitted in their password  # noqa: E501

        :return: The exclude_last_name of this PasswordPolicyComplexityDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def exclude_last_name(self, exclude_last_name):
        """Sets the exclude_last_name of this PasswordPolicyComplexityDto.

        Rule determining whether a user's last name should be permitted in their password  # noqa: E501

        :param exclude_last_name: The exclude_last_name of this PasswordPolicyComplexityDto.  # noqa: E501
        :type exclude_last_name: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PasswordPolicyComplexityDto):
            return False
