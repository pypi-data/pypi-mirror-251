...
${G_myName} ${extraInfo} -i deBisosIfy       # PRIMARY: For regression testing and updating
...
${G_myName} ${extraInfo} -i sysBasePlatform   # PRIMARY: Minimal Host or Guest plus Blee
_EOF_
