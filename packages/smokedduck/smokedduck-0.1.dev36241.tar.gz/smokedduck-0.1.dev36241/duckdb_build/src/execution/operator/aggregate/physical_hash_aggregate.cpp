...
#ifdef LINEAGE
			output_chunk.trace_lineage = ClientConfig::GetConfig(executor.context).trace_lineage;
...
#ifdef LINEAGE
			group_chunk.trace_lineage = ClientConfig::GetConfig(executor.context).trace_lineage;
