...
jupyter_content_aliases = dict(base_aliases)
jupyter_content_aliases["cloud"] = "JupyterContentBaseApp.cloud"
jupyter_content_aliases["server-base-url"] = "JupyterContentBaseApp.server_base_url"
jupyter_content_aliases["server-base-ws-url"] = "JupyterContentBaseApp.server_base_ws_url"
jupyter_content_aliases["server-token"] = "JupyterContentBaseApp.server_token"

jupyter_content_flags = dict(base_flags)
jupyter_content_flags["no-minimize"] = (
...
class JupyterContentBaseApp(DatalayerApp):
    ...
    aliases = jupyter_content_aliases

    flags = jupyter_content_flags
