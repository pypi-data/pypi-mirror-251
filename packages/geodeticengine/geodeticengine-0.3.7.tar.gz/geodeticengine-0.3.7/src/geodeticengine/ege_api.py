...
class EGE:
    ...
    def __init__(self):
        ...
        self.GE_ENDPOINT_ENGINEERING = f"{self.GE_API}/transformation/engineering"
    ...
    def call_endpoint(self, endpoint,  http_method='get', input_params_dict=None):
        ...
        try:
            if http_method.lower() == 'get':
                ...
                response = requests.post(endpoint, headers=self.auth.authorization_headers(self.GE_API), data=json_payload, timeout=30)
            else:
