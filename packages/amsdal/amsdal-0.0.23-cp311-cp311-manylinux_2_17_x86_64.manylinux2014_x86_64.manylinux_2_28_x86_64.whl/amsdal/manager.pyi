...
from amsdal.authentication.deploy_service import DeployModel as DeployModel, DeployService as DeployService
...
class AmsdalManager(BuildMixin, ClassVersionsMixin, metaclass=Singleton):
    ...
    def list_deployments(self) -> list[DeployModel]: ...
    def update_deployment_status(self, deploy_id: str) -> None: ...
    def destroy_deployment(self, deploy_id: str) -> None: ...
