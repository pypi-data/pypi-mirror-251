...
tkinter.Button(text="hide(True)", command=lambda :hide(True) ).place(x=100, y=660)
tkinter.Button(text="hide(False)", command=lambda :hide(False) ).place(x=100, y=690)
