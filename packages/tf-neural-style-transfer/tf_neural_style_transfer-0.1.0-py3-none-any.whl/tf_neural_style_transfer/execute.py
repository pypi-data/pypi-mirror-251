...
content_path = tf.keras.utils.get_file(os.environ["TARGET_IMAGE_NAME"], os.environ["TARGET_IMAGE_URL"])
style_path = tf.keras.utils.get_file(os.environ["REFERENCE_IMAGE_NAME"], os.environ["REFERENCE_IMAGE_URL"])
