...
from hcs_cli.support.param_util import parse_vm_params
import hcs_core.sglib.cli_options as cli
import hcs_core.ctxp.data_util as data_util


@click.command()
@click.option("--template", "-t", type=str, required=False, help="Template id")
@click.option("--vm", "-v", type=str, required=False, help="VM id")
@cli.org_id
@click.option(
    "--update",
    "-u",
...
def update(template: str, vm: str, org: str, update: str, vm_path: str):
    """Update a specific VM."""
    template_id, vm_id = parse_vm_params(template, vm, vm_path)
