...
def chat(prompts, system_messages, model="gpt-3.5-turbo-0613", cache = True, api_key=None, verbose=False, as_str=False, **kwargs):
    """
...
@override
def embed(texts, cache=True, as_np=False, api_key=None, verbose=False):
    """
