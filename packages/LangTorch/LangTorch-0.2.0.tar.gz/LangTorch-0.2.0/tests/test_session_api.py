...
out = Activation()(TextTensor([["test: Answer yes in three lines"], ["test: Answer no in three lines"]]))
out2 = Activation(model = "gpt-4-1106-preview", T=1, max_tokens = 100)(TextTensor([["Napisz listę rymów do Mieszko. Oddziel słowa jedynie spacją"]]*2))
