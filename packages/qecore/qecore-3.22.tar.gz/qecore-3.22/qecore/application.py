...
class Application:
    ...
    def get_desktop_file_data(self) -> None:
        ...
        if self.desktop_file_path:
            ...
            log.debug(f"get_desktop_file_data: .desktop file found: '{desktop_file}'")
    ...
    def is_running(self) -> bool:
        ...
        behaviour. You do not need to use this by yourself, but can be useful in some
        situations.
        """
    ...
    def get_all_kill_candidates(self) -> list:
        ...
        This prevents testname colliding with found process so that
