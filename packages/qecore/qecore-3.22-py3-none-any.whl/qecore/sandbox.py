...
class TestSandbox:
    ...
    def _before_feature(self, context, feature) -> None:
        ...
        cmdline_tags = context.config.tags.ands[0]
    ...
    def _gracefull_exit(self, signum, frame) -> None:
        """
    ...
    def _start_recording(self) -> None:
        ...
        log.debug(f"Active recording decected: '{active_script_recordings}'")
    ...
    def _attach_coredump_log_to_report(self, context) -> None:
        ...
        if not (
            ...
            log.debug(f"self.attach_coredump_file_check='{short_crdmp_check}'.")
            return
                ...
                for scenario in feature.scenarios:
                    ...
                    for tag in scenario.tags:
                        ...
                        # Either it becomes a link to Jira
                            ...
                            # Exctract just the number from th @RHEL tag so we can link
                            # it to Jira.
    ...
    def _wait_for_video_encoding(self, file_name) -> None:
        ...
        having an entire video with all controling elements (sometimes the video cannot
        be moved to the middle, or does not have data abouts its length).
