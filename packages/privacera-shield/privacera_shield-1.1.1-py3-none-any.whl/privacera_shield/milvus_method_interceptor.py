...
class MilvusCollectionInterceptorSetup:
    ...
    def __init__(self, **kwargs):
        ...
        self.filter_in_classes = ["Collection"] if "filter_in_classes" not in kwargs else kwargs["filter_in_classes"]
...
class MilvusFilterCallback(MethodIOCallback):
    ...
    def process_inputs(self, *args, **kwargs):
        ...
        access_result = self.paig_plugin.get_shield_client().get_filter_expression(access_request)
