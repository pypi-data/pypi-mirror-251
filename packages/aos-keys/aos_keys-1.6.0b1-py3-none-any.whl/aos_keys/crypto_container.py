...
class AosCryptoContainer:
    ...
    def __init__(self, file_path: typing.Union[str, os.PathLike]):
        ...
        self._key_and_certificates: typing.Optional[serialization.pkcs12.PKCS12KeyAndCertificates] = None
    ...
    def load(self):
        ...
        self._key_and_certificates = serialization.pkcs12.load_pkcs12(self._p12_bytes, None)
