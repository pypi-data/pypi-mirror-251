...
def train_test_split(df, n_splits=12, stratify_on=None, group_on=None, ts_split_on=None, val_size=0.0):
    for split in cv_split(df, n_splits=n_splits, stratify_on=stratify_on, group_on=group_on, ts_split_on=ts_split_on, val_size=val_size):
        return split
