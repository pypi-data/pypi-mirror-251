...
class Structure_Database:
    ...
    def __init__(self,foldseek_executable,tmp_dir,SCOP_SF_db_info_tsv="database/db_info.tsv",foldseek_SCOP_db="database/foldseek_db/db"):
        self.foldseek_executable = foldseek_executable
        self.tmp_dir = tmp_dir
        self.SCOP_SF_db_info_tsv = SCOP_SF_db_info_tsv
        self.foldseek_SCOP_db= foldseek_SCOP_db
