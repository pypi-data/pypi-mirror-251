...
def db_set_SF_pymol_rot(SF_number: str,pymol_output):
    ...
    Returns:
    - returns nothing but changes the db entry of the given SF_number. Proteins matched to this SF will now be rotated using the new rotation matrix when using family_vis = True.
    """
    db= Structure_Database(None,None)
