...
class ChatBotUITemplate(object):
    ...
    def get_chain_reponse(self, input: str, chat_history: List[Any]) -> str:
        ...
        if not self.chain:
            ...
            response = self.chain.invoke(dict(input=input, chat_history=chat_history))
            return response
...
class SingleModelChatBotUITemplate(object):
    ...
    def get_chain_reponse(self, input: str, chat_history: List[Any], model:str, temperature:float) -> str:
        ...
        if not self.chain:
            ...
            response = self.chain.invoke(dict(input=input, chat_history=chat_history, model=model, temperature=temperature))
            return response
