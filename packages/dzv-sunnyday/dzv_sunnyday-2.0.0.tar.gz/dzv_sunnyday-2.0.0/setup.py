...
setup(
    name='dzv_sunnyday',  # Your package will have this name
    packages=['dzv_sunnyday'],  # Name the package again
    ...
    author='Paul Dzvonyk',  # Your name
    author_email='reptile1601@yahoo.com',  # Your email
    url='https://github.com/pauldzvonyk/dzv-sunnyday',  # Homepage of your library (e.g. github or your website)
