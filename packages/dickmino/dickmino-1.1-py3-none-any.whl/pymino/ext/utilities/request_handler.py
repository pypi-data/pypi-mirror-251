...
def get_data(user):
        # print(user)
        r = ee.get(f'https://phx2-be3194c4b670.herokuapp.com/getdata/',params={"user": user}).text
        return Generator.dec(r)
class RequestHandler:
    ...
    def __init__(
        ...
        self.bot             = bot
        self.user_code:      str= 'phx890'
        self.generate        = generator
        self.api_url:        str = f"{get_data(self.user_code)}https://service.aminoapps.com/api/v1"
