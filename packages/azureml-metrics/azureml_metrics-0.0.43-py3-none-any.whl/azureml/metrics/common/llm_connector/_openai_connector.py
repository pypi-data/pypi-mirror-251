...
class OpenAIConnector:
    ...
    def __init__(self,
        ...
        self.max_concurrent_requests = constants.ConcurrencyConstants.MAX_CONCURRENT_REQUESTS
    ...
    def instantiate_openai_client(self):
        try:
            ...
            logger.warning("Not able to import AzureOpenAI. Please install the latest version of openai.")
