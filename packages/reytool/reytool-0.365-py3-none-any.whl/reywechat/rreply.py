...
class RReply(object):
    ...
    def __init__(
        ...
        self.rules: List[Dict[Literal["judge", "send", "level"], Any]] = []
    ...
    def _reply_by_rule(self) -> None:
        ...
        def handler_reply_by_rule(message: RMessage) -> None:
            ...
            for rule in self.rules:
                ...
                send: Callable[[RMessage], Optional[Union[Dict, List[Dict]]]] = rule["send"]
                ...
                if result:
                    ...
                    # Send.
                    params_list = send(message)
                    if params_list is not None:
                        if params_list.__class__ == dict:
                            params_list: List[Dict] = [params_list]
    ...
    def add_rule(
        ...
        send: Callable[[RMessage], Optional[Union[Dict, List[Dict]]]],
        level: float = 1
    ) -> None:
        """
        Add reply rule.
        ...
        send : Function to generate send parameters.
