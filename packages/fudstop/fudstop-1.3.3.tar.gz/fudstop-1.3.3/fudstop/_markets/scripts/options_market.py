...
from webhook_dicts import option_conditions_hooks
from embeddings import sized_trade_embed, specials_embed_2, dip_specials_embed, index_surge_embed, dip_specials_embed_2_super, theta_resistant_embed
...
class OptionsMarket:
    def __init__(self, database:str='markets', user:str='chuck', password:str='fud', port:int=5432, host:str='localhost'):
        ...
        self.wb_opts = WebullOptions(user='chuck', database='charlie', host='localhost', port=5432, password='fud')
        self.conn = None
        self.pool = None
