...
def gen_pdf_ar4(pdf_save_path, Results):
    """
    生成分析报告
    :param pdf_save_path: PDF文件保存路径
    :param Results: 结果集
    ...
    # Create an Image object with the iterable object
    # print("------------Creating File---------------------")
    TFimg = Image(Results["sleep_plot"], width=495, height=315) if Results["sleep_plot"] is not None else Image(
