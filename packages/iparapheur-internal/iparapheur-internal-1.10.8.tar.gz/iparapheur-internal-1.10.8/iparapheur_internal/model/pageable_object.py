...
class PageableObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["unpaged", "pageSize", "paged", "pageNumber", "offset", "sort", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["unpaged", "pageSize", "paged", "pageNumber", "offset", "sort", ], str]):
