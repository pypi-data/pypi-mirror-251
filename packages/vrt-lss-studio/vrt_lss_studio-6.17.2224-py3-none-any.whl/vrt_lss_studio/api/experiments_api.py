...
class ExperimentsApi:
    ...
    @validate_arguments
    def import_json_url(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], url : Annotated[str, Field(min_length=10, strict=True, max_length=512, description="Url to json file.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def import_json_url_with_http_info(self, experiment_key : Annotated[StrictStr, Field(description="Key, unique identifier.")], url : Annotated[str, Field(min_length=10, strict=True, max_length=512, description="Url to json file.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Import by URL (JSON)  # noqa: E501
