...
# 日志部分
def getLog(file_name=None, root=None, level=logging.INFO, file_level=logging.INFO, date_suffix=False,
           max_bytes=None, back_count=5, output_window=True, output_file=True):
    """
