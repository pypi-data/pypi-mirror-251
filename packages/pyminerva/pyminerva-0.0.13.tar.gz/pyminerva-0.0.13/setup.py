...
python -m twine upload dist/*
    ...
    pypi-AgEIcHlwaS5vcmcCJDFkNzU2ODVhLTEwYTYtNGYxNi1iMmVkLTZmNjljYzZlMmEwYQACKlszLCJkYjIwYjVkZS1mMzJmLTRlMjYtOTVhZi01Y2I4M2Y4NzQyOTEiXQAABiCGXTfwiiiUFuNE6ddgrdthbm8l8nWnb00JxwC5fEkf3Q
    )
...
python -m twine upload --repository testpypi dist/*
    ...
    Set your username to __token__
    Set your password to the token value, including the pypi- prefix)
python -m pip install --index-url https://test.pypi.org/simple/ --no-deps pyminerva
https://test.pypi.org/simple/ pyminerva
...
setup(
    name='pyminerva',
    version='0.0.13',    # version.directory.file
