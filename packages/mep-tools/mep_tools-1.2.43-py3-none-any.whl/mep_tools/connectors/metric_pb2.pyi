...
class MetricCreateRequest(_message.Message):
    __slots__ = ["connect_portal_uuid", "key", "name", "custom", "type", "configuration", "connected_metrics"]
    CONNECT_PORTAL_UUID_FIELD_NUMBER: _ClassVar[int]
    ...
    connected_metrics: str
    def __init__(self, connect_portal_uuid: _Optional[str] = ..., key: _Optional[str] = ..., name: _Optional[str] = ..., custom: _Optional[str] = ..., type: _Optional[_Union[MetricType, str]] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., connected_metrics: _Optional[str] = ...) -> None: ...
