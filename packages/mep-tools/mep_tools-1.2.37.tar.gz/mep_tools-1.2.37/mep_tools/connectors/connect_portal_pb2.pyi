...
class PortalResponse(_message.Message):
    __slots__ = ["operation", "success", "portal_uuid", "name", "type", "key", "className", "configuration", "created_at", "updated_at"]
    ...
    def __init__(self, operation: _Optional[_Union[OperationEnum, str]] = ..., success: bool = ..., portal_uuid: _Optional[str] = ..., name: _Optional[str] = ..., type: _Optional[_Union[TypeEnum, str]] = ..., key: _Optional[str] = ..., className: _Optional[str] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
