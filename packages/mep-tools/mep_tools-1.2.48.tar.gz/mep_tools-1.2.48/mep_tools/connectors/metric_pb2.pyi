...
class MetricResponse(_message.Message):
    __slots__ = ["operation", "success", "uuid", "key", "name", "custom", "type", "connect_portal_uuid", "company_uuid", "connected_metrics", "configuration", "created_at", "updated_at", "connect_portal_method"]
    ...
    def __init__(self, operation: _Optional[_Union[OperationEnum, str]] = ..., success: bool = ..., uuid: _Optional[str] = ..., key: _Optional[str] = ..., name: _Optional[str] = ..., custom: bool = ..., type: _Optional[_Union[MetricType, str]] = ..., connect_portal_uuid: _Optional[str] = ..., company_uuid: _Optional[str] = ..., connected_metrics: _Optional[_Iterable[str]] = ..., configuration: _Optional[_Union[_any_pb2.Any, _Mapping]] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., connect_portal_method: _Optional[str] = ...) -> None: ...
