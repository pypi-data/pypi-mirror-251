...
import connectors_pb2 as connectors__pb2
...
class ConnectorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Dispatcher = channel.unary_stream(
                ...
                request_serializer=connectors__pb2.DispatcherRequest.SerializeToString,
                response_deserializer=connectors__pb2.DispatcherResponse.FromString,
                )
...
def add_ConnectorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Dispatcher': grpc.unary_stream_rpc_method_handler(
                    servicer.Dispatcher,
                    request_deserializer=connectors__pb2.DispatcherRequest.FromString,
                    response_serializer=connectors__pb2.DispatcherResponse.SerializeToString,
            ),
    }
...
class ConnectorService(object):
    ...
    def Dispatcher(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/connector.connector.ConnectorService/Dispatcher',
            connectors__pb2.DispatcherRequest.SerializeToString,
            connectors__pb2.DispatcherResponse.FromString,
