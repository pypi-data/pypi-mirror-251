...
from fastapi_identity.token_provider import EmailTokenProvider, PhoneNumberTokenProvider, DefaultTokenProvider
...
class TokenOptions:
    ...
    def __init__(self):
        ...
        self.AUTHENTICATOR_ISSUER: str = "FastAPIIdentity.Auth"
        """"""
