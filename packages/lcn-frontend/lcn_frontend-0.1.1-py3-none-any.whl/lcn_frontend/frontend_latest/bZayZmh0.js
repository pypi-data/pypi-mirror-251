export const id=981;export const ids=[981];export const modules={981:(t,e,i)=>{i.r(e),i.d(e,{LCNEntitiesPage:()=>f});var s=i(309),a=i(4541),n=i(7838),d=i(8144),o=i(4243),l=(i(657),i(1952),i(4776),i(8336),i(7662),i(9040),i(4371),i(4516)),r=i(1750),c=i(9051);const h="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";(0,s.Z)([(0,o.Mo)("lcn-entities-data-table")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"lcn",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"narrow",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"device",value:void 0},{kind:"field",decorators:[(0,o.Cb)({attribute:!1})],key:"entities",value(){return[]}},{kind:"field",key:"_entities",value(){return(0,l.Z)((t=>t.map((t=>({...t,delete:t})))))}},{kind:"field",key:"_columns",value(){return(0,l.Z)((t=>t?{name:{title:this.lcn.localize("entity-id"),sortable:!0,direction:"asc",grows:!0},delete:{title:"",sortable:!1,width:"80px",template:t=>d.dy`
                  <ha-icon-button
                    title=${this.lcn.localize("dashboard-entities-table-delete")}
                    .path=${h}
                    @click=${e=>this._onEntityDelete(e,t)}
                  ></ha-icon-button>
                `}}:{name:{title:this.lcn.localize("entity-id"),sortable:!0,direction:"asc",grows:!0,width:"35%"},domain:{title:this.lcn.localize("domain"),sortable:!0,grows:!1,width:"25%"},resource:{title:this.lcn.localize("resource"),sortable:!0,grows:!1,width:"25%"},delete:{title:"",sortable:!1,width:"80px",template:t=>d.dy`
                  <ha-icon-button
                    title=${this.lcn.localize("dashboard-entities-table-delete")}
                    .path=${h}
                    @click=${e=>this._onEntityDelete(e,t)}
