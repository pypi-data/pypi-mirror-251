...
class TableUiBlock:
    ...
    _name: str
    _source: Union[TableUiBlockDatasetSource, UnknownType]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_source() -> Union[TableUiBlockDatasetSource, UnknownType]:
            source: Union[TableUiBlockDatasetSource, UnknownType]
        ...
        try:
            ...
            if strict:
                raise
            source = cast(Union[TableUiBlockDatasetSource, UnknownType], UNSET)
