...
class TableUiBlockUpdate:
    ...
    _source: Union[Unset, TableUiBlockDatasetSource, UnknownType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_source() -> Union[Unset, TableUiBlockDatasetSource, UnknownType]:
            source: Union[Unset, TableUiBlockDatasetSource, UnknownType]
        ...
        try:
            ...
            if strict:
                raise
            source = cast(Union[Unset, TableUiBlockDatasetSource, UnknownType], UNSET)
    ...
    @property
    def source(self) -> Union[TableUiBlockDatasetSource, UnknownType]:
        if isinstance(self._source, Unset):
            raise NotPresentError(self, "source")
        return self._source

    @source.setter
    def source(self, value: Union[TableUiBlockDatasetSource, UnknownType]) -> None:
        self._source = value
