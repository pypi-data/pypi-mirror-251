...
class PhotoIdentifierBulkUpdateUpdateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhotoIdentifierBulkUpdateUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhotoIdentifierBulkUpdateUpdateRequest:
        """Create an instance of PhotoIdentifierBulkUpdateUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhotoIdentifierBulkUpdateUpdateRequest.parse_obj(obj)

        _obj = PhotoIdentifierBulkUpdateUpdateRequest.parse_obj({
