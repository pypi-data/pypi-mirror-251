...
class V1Beta1PhotoIdentifierSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1Beta1PhotoIdentifierSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1Beta1PhotoIdentifierSummary:
        """Create an instance of V1Beta1PhotoIdentifierSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1Beta1PhotoIdentifierSummary.parse_obj(obj)

        _obj = V1Beta1PhotoIdentifierSummary.parse_obj({
            "id": obj.get("id"),
