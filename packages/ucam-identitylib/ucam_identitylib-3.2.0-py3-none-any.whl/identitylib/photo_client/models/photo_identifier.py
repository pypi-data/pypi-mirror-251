...
class PhotoIdentifier(BaseModel):
    ...
    is_highest_primary_identifier: Optional[StrictBool] = Field(None, alias="isHighestPrimaryIdentifier", description="Photo identifier is highest primary identifier")
    photos: conlist(StrictStr) = Field(..., description="Photos identified by this identifier")
    related_identifiers: conlist(V1Beta1PhotoIdentifierSummary) = Field(..., alias="relatedIdentifiers")
    ...
    __properties = ["deletedAt", "id", "isDeleted", "isHighestPrimaryIdentifier", "photos", "relatedIdentifiers", "retainUntil", "scheme", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhotoIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhotoIdentifier:
        """Create an instance of PhotoIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhotoIdentifier.parse_obj(obj)

        _obj = PhotoIdentifier.parse_obj({
            "deleted_at": obj.get("deletedAt"),
            "id": obj.get("id"),
            "is_deleted": obj.get("isDeleted"),
            "is_highest_primary_identifier": obj.get("isHighestPrimaryIdentifier"),
            "photos": obj.get("photos"),
            "related_identifiers": [V1Beta1PhotoIdentifierSummary.from_dict(_item) for _item in obj.get("relatedIdentifiers")] if obj.get("relatedIdentifiers") is not None else None,
