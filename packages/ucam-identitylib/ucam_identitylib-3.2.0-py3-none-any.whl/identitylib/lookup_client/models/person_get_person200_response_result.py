...
class PersonGetPerson200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonGetPerson200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonGetPerson200ResponseResult:
        """Create an instance of PersonGetPerson200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonGetPerson200ResponseResult.parse_obj(obj)

        _obj = PersonGetPerson200ResponseResult.parse_obj({
