...
class GroupAllGroups200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupAllGroups200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupAllGroups200ResponseResult:
        """Create an instance of GroupAllGroups200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupAllGroups200ResponseResult.parse_obj(obj)

        _obj = GroupAllGroups200ResponseResult.parse_obj({
