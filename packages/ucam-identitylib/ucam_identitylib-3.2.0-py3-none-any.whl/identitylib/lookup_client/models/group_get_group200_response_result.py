...
class GroupGetGroup200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupGetGroup200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupGetGroup200ResponseResult:
        """Create an instance of GroupGetGroup200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupGetGroup200ResponseResult.parse_obj(obj)

        _obj = GroupGetGroup200ResponseResult.parse_obj({
