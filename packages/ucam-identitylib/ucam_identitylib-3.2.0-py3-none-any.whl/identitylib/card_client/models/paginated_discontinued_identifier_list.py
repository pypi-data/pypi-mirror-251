...
class PaginatedDiscontinuedIdentifierList(BaseModel):
    ...
    results: Optional[conlist(DiscontinuedIdentifier)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedDiscontinuedIdentifierList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedDiscontinuedIdentifierList:
        """Create an instance of PaginatedDiscontinuedIdentifierList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedDiscontinuedIdentifierList.parse_obj(obj)

        _obj = PaginatedDiscontinuedIdentifierList.parse_obj({
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [DiscontinuedIdentifier.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
