...
class RevokedAtNotesType(BaseModel):
    ...
    RevokedAtNotesType
    """
    change_of_details: Optional[StrictInt] = Field(None, alias="ChangeOfDetails")
    change_of_role: Optional[StrictInt] = Field(None, alias="ChangeOfRole")
    expiring: Optional[StrictInt] = Field(None, alias="Expiring")
    incorrect_details: Optional[StrictInt] = Field(None, alias="IncorrectDetails")
    lost_by_cardholder: Optional[StrictInt] = Field(None, alias="LostByCardholder")
    lost_in_transit: Optional[StrictInt] = Field(None, alias="LostInTransit")
    no_longer_requiresa_card: Optional[StrictInt] = Field(None, alias="NoLongerRequiresaCard")
    not_working_electronic_issue: Optional[StrictInt] = Field(None, alias="NotWorkingElectronicIssue")
    not_working_physical_damage: Optional[StrictInt] = Field(None, alias="NotWorkingPhysicalDamage")
    other: Optional[StrictInt] = Field(None, alias="Other")
    print_faded: Optional[StrictInt] = Field(None, alias="PrintFaded")
    stolen: Optional[StrictInt] = Field(None, alias="Stolen")
    var_date: date = Field(..., alias="date")
    __properties = ["ChangeOfDetails", "ChangeOfRole", "Expiring", "IncorrectDetails", "LostByCardholder", "LostInTransit", "NoLongerRequiresaCard", "NotWorkingElectronicIssue", "NotWorkingPhysicalDamage", "Other", "PrintFaded", "Stolen", "date"]
    ...
    def from_dict(cls, obj: dict) -> RevokedAtNotesType:
        ...
        _obj = RevokedAtNotesType.parse_obj({
            "change_of_details": obj.get("ChangeOfDetails"),
            "change_of_role": obj.get("ChangeOfRole"),
            "expiring": obj.get("Expiring"),
            "incorrect_details": obj.get("IncorrectDetails"),
            "lost_by_cardholder": obj.get("LostByCardholder"),
            "lost_in_transit": obj.get("LostInTransit"),
            "no_longer_requiresa_card": obj.get("NoLongerRequiresaCard"),
            "not_working_electronic_issue": obj.get("NotWorkingElectronicIssue"),
            "not_working_physical_damage": obj.get("NotWorkingPhysicalDamage"),
            "other": obj.get("Other"),
            "print_faded": obj.get("PrintFaded"),
