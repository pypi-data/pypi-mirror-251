...
class MetricsListResponseType(BaseModel):
    ...
    """
    issued_at: Optional[conlist(IssuedAtType)] = Field(None, alias="issuedAt")
    revoked_at: Optional[conlist(RevokedAtType)] = Field(None, alias="revokedAt")
    revoked_at_notes: Optional[conlist(RevokedAtNotesType)] = Field(None, alias="revokedAtNotes")
