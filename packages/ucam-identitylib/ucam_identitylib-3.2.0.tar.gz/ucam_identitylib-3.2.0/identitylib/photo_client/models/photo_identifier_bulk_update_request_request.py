...
class PhotoIdentifierBulkUpdateRequestRequest(BaseModel):
    ...
    """
    updates: conlist(PhotoIdentifierBulkUpdateUpdateRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhotoIdentifierBulkUpdateRequestRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhotoIdentifierBulkUpdateRequestRequest:
        """Create an instance of PhotoIdentifierBulkUpdateRequestRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhotoIdentifierBulkUpdateRequestRequest.parse_obj(obj)

        _obj = PhotoIdentifierBulkUpdateRequestRequest.parse_obj({
            "updates": [PhotoIdentifierBulkUpdateUpdateRequest.from_dict(_item) for _item in obj.get("updates")] if obj.get("updates") is not None else None
        })
        return _obj
