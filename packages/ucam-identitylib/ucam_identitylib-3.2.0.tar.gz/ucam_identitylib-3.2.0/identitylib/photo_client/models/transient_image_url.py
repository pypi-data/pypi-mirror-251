...
class TransientImageUrl(BaseModel):
    ...
    """
    expiration_seconds: StrictInt = Field(..., alias="expirationSeconds", description="Get the number of seconds until this image link will expire.")
    url: StrictStr = Field(..., description="Get the image url.")
    __properties = ["expirationSeconds", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransientImageUrl:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransientImageUrl:
        """Create an instance of TransientImageUrl from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransientImageUrl.parse_obj(obj)

        _obj = TransientImageUrl.parse_obj({
