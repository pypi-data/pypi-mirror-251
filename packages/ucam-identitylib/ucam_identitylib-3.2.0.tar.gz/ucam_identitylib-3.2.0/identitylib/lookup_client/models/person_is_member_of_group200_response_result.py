...
class PersonIsMemberOfGroup200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonIsMemberOfGroup200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonIsMemberOfGroup200ResponseResult:
        """Create an instance of PersonIsMemberOfGroup200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonIsMemberOfGroup200ResponseResult.parse_obj(obj)

        _obj = PersonIsMemberOfGroup200ResponseResult.parse_obj({
            "value": obj.get("value")
        })
        return _obj
