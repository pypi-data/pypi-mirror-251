...
class InstitutionAllInsts200ResponseResult(BaseModel):
    ...
    """
    institutions: Optional[conlist(Institution)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionAllInsts200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionAllInsts200ResponseResult:
        """Create an instance of InstitutionAllInsts200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionAllInsts200ResponseResult.parse_obj(obj)

        _obj = InstitutionAllInsts200ResponseResult.parse_obj({
