...
class GroupGetCancelledMembers200ResponseResult(BaseModel):
    ...
    """
    people: Optional[conlist(Person)] = None
    __properties = ["people"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupGetCancelledMembers200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupGetCancelledMembers200ResponseResult:
        """Create an instance of GroupGetCancelledMembers200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupGetCancelledMembers200ResponseResult.parse_obj(obj)

        _obj = GroupGetCancelledMembers200ResponseResult.parse_obj({
