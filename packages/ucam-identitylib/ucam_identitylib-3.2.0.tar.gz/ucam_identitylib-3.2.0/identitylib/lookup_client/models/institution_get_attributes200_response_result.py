...
class InstitutionGetAttributes200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionGetAttributes200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionGetAttributes200ResponseResult:
        """Create an instance of InstitutionGetAttributes200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionGetAttributes200ResponseResult.parse_obj(obj)

        _obj = InstitutionGetAttributes200ResponseResult.parse_obj({
