...
class InstitutionGetInst200ResponseResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionGetInst200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionGetInst200ResponseResult:
        """Create an instance of InstitutionGetInst200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionGetInst200ResponseResult.parse_obj(obj)

        _obj = InstitutionGetInst200ResponseResult.parse_obj({
            "institution": Institution.from_dict(obj.get("institution")) if obj.get("institution") is not None else None
        })
        return _obj
