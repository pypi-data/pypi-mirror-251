...
class InstitutionGetContactRows200ResponseResult(BaseModel):
    ...
    """
    institution_contact_rows: Optional[conlist(ContactRow)] = Field(None, alias="institution.contactRows")
    __properties = ["institution.contactRows"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstitutionGetContactRows200ResponseResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstitutionGetContactRows200ResponseResult:
        """Create an instance of InstitutionGetContactRows200ResponseResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstitutionGetContactRows200ResponseResult.parse_obj(obj)

        _obj = InstitutionGetContactRows200ResponseResult.parse_obj({
            "institution_contact_rows": [ContactRow.from_dict(_item) for _item in obj.get("institution.contactRows")] if obj.get("institution.contactRows") is not None else None
        })
        return _obj
