...
class PaginatedResultsStudent(BaseModel):
    ...
    results: conlist(Student) = Field(..., description="A list of the current page of results.")
    ...
    def from_dict(cls, obj: dict) -> PaginatedResultsStudent:
        ...
        _obj = PaginatedResultsStudent.parse_obj({
            ...
            "results": [Student.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
