...
class EdatLogService:
    ...
    def __get_connection(self):
        ...
        """
        try:
            USERNAME = quote_plus(os.environ.get('USER_LOG', default=''))
            PASSWORD = quote_plus(os.environ.get('PASSWORD_LOG', default=''))
            HOST = os.environ.get('HOST_LOG', default='')
            PORT = os.environ.get('PORT_LOG', default=5432)
            DB = os.environ.get('DB_LOG', default='')
