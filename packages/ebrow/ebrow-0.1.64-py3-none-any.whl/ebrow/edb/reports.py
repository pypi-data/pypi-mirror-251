...
class Report:
    ...
    def _reportHTML(self):
        ...
        copy2(self._settings.readSettingAsString('logoPath'), self._imgPath)
        ...
        if self._parent.covID < 2 or self._totalDays < 2:
            ...
            if not self._parent.batchReport:
...
'''.format(self._isChecked('OVER'), self._isChecked('UNDER'), self._isChecked('FAKE ESD'),
