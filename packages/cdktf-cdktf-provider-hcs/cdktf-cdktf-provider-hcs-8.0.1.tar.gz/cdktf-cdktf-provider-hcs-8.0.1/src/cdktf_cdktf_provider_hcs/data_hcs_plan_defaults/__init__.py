...
class DataHcsPlanDefaults(
    ...
    def generate_config_for_import(
        ...
        '''Generates CDKTF code for importing a DataHcsPlanDefaults resource upon running "cdktf plan ".

        :param scope: The scope in which to define this construct.
        :param import_to_id: The construct id used in the generated config for the DataHcsPlanDefaults to import.
        :param import_from_id: The id of the existing DataHcsPlanDefaults that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/hcs/0.5.1/docs/data-sources/plan_defaults#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the DataHcsPlanDefaults to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0feb3d36de6796867462712b482fe1abe323b2b950f0cf326ba89e7048c1cb69)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, "DataHcsPlanDefaultsTimeouts"]]:
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, "DataHcsPlanDefaultsTimeouts"]], jsii.get(self, "timeoutsInput"))
...
class DataHcsPlanDefaultsTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, DataHcsPlanDefaultsTimeouts]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[_cdktf_9a9027ec.IResolvable, DataHcsPlanDefaultsTimeouts]],
    ) -> None:
        if __debug__:
...
def _typecheckingstub__0feb3d36de6796867462712b482fe1abe323b2b950f0cf326ba89e7048c1cb69(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
