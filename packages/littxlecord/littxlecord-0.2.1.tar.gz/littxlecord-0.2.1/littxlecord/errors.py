...
class littxlecordException(Exception):
    """Base exception class for all littxlecord exceptions."""


class ConvertTimeError(littxlecordException):
    """Raised when a time conversion fails."""


class Blacklisted(littxlecordException):
