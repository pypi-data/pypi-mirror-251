...
class Bot(_main_bot):  # type: ignore
    """The littxlecord bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        lcConfig.lang = language
        lcConfig.default_lang = default_language
    ...
    async def get_application_context(self, interaction: discord.Interaction, cls=lcContext):
    ...
    def add_help_command(
        ...
        **kwargs: Callable | str,
        ...
        embed:
            ...
            embed will be used.
            All template variables that are listed in :meth:`littxlecord.emb.set_embed_templates`
            can be used here.
        show_categories:
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("littxlecord.cogs.pyc.help_setup", package="littxlecord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("littxlecord.cogs.pyc.status_changer_setup", package="littxlecord")
    ...
    def add_blacklist(
        ...
        *,
        ...
        disabled_commands: list[lcConfig.BLACKLIST_COMMANDS] | None = None,
        **kwargs: Callable,
    ):
        ...
        **kwargs:
        ...
        for name, func in kwargs.items():
            if name not in lcConfig.BLACKLIST_COMMANDS.__args__:  # type: ignore
                raise ValueError(
                    f"Invalid blacklist command name '{name}'. "
                    f"Possible values are: {lcConfig.BLACKLIST_COMMANDS.__args__}."  # type: ignore
                )

            if not asyncio.iscoroutinefunction(func):
                raise TypeError(f"Blacklist command overwrite `{name}` must be async.")

        lcConfig.blacklist = Blacklist(
            db_path,
            db_name,
            raise_error,
            owner_only,
        ...
        lcConfig.admin_guilds = admin_server_ids

        self.enabled_extensions.append("blacklist")
        if not DPY:
            self.load_extension("littxlecord.cogs.pyc.blacklist_setup", package="littxlecord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="littxlecord")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use littxlecord with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use littxlecord with bridge commands.
    This is only needed for Pycord.
    """
