...
class GatewayServer:
    ...
    def __init__(
            ...
            sessionobj=None,
            RESTurl="",
    ): #session obj needed for proxies and some combo gateway functions (that also require http api wraps)
        # self.auth_token = auth_token
        # self.x_super_properties = x_super_properties
        # self.auth = {
        #     "token": self.auth_token,
        #     "capabilities": 509,
        #     "properties": self.x_super_properties,
        #     "presence": {
        #         "status": "online",
        #         "since": 0,
        #         "activities": [],
        ...
        self.ws = self._get_ws_app(self.websocket_url)
