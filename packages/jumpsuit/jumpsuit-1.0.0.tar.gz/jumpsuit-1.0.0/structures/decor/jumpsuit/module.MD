...
Bravo!  You have received a Medical Diploma in "jumpsuit" from   
the Orbital Convergence University International Air and Water Embassy of the Tangerine Planet.  

You are now officially certified to include "jumpsuit" in your practice.
...
`[ZSH] jumpsuit internal-status`
	
These checks are run with pypi "body_scan"  
"jumpsuit" is built from a fork of "body_scan"  
...
`[ZSH] jumpsuit status --glob-string "**/status_*.py"`
		...
		"checks": [
			...
			},
			{
				...
				"exception trace": [
					...
					"  File \"/home/veganecology/.local/lib/python3.11/site-packages/jumpsuit/processes/scan/process/keg/check.py\", line 68, in start",
					"    checks [ check ] ()",
...
It's recommended to run jumpsuit programmatilly.  
