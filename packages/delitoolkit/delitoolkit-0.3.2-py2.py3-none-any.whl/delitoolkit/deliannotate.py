...
class DeliAnnotationPredictor:
    def __init__(self, type_path='delitoolkit/models/predicting_type.zip',
                 probing_target_path='delitoolkit/models/predicting_probing_target_delidata20rc.zip',
                 nonprobing_target_path='delitoolkit/models/predicting_nonprobing_target_delidata20rc.zip') -> None:
