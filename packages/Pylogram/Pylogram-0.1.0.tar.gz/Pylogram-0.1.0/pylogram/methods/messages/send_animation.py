...
import pylogram
from pylogram import StopTransmission, enums
...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~pylogram.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~pylogram.Client.stop_transmission`, None is
            returned.
