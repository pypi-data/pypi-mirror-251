...
import pylogram
from pylogram import enums, utils
...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~pylogram.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~pylogram.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~pylogram.enums.UserStatus.ONLINE`.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~pylogram.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~pylogram.types.User`.
