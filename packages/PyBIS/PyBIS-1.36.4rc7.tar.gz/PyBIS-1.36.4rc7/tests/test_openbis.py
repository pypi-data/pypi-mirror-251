...
def test_new_experiment():
    ...
    # et = o.get_collection_type('MY_COLL')
    # ps = et.get_property_assignments()

    pt = o.new_property_type('MY_PROP', 'my prop', 'my prop', 'DATE')
    pt.save()

    # coll = o.get_collection('20240105130801331-49')

    st = o.new_sample_type('my_sample2', 'mysamp-', autoGeneratedCode=True, description="some new type description")
    st.save()
    st.assign_property('my_prop', unique=True)

    # dt = o.new_dataset_type('my_dataset')
    # dt.save()
    # dt.assign_property('my_prop', unique=True)


    ds = o.get_dataset('20240105152236777-55')
