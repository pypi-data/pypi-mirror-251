...
from Orange.data import Table
print (in_classifier.domain)
out_data = Table.from_domain(in_classifier.domain)
print(len(in_classifier.domain))
listofzeros = [0] * len(in_classifier.domain)
out_data = Table.from_list(in_classifier.domain,[listofzeros])
print(dir(in_classifier))
print(in_classifier.original_data)
