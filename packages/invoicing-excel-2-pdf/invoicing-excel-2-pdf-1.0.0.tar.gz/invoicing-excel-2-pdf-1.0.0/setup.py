...
setup(
  name = 'invoicing-excel-2-pdf',         #* Your package will have this name
  ...
  author = 'Ogochukwu Ozotta',                   # Your name
  author_email = 'ogochukwu.ozotta@gmail.com',  # Your email
  url = 'https://github.com/python-dev-og/python-package',              # Homepage of your library (e.g. github or your website)
  keywords = ['invoice', 'excel', 'pdf', 'invoicing', 'generate invoice', 'excel to pdf'],   # Keywords users can search on pypi.org
