...
def _update_media_builder(AUTH_TOKEN, URL, NAME, DESTINATION_FOLDER_ID, COLLECTIONS,
                          RELATED_CONTENT, PROPERTIES, DEBUG):
    
    API_URL = f"{URL}/mediaBuilder"
    ...
    INFO = _get_media_builder(AUTH_TOKEN, URL, DEBUG)
