...
from dektools.file.hit import FileHitChecker
from dektools.file.operation import read_text, read_file, write_file
...
class Template:
    ...
    def get_hit_rules(self, template_path, filepath):
        ignore_file = os.path.join(template_path, filepath)
