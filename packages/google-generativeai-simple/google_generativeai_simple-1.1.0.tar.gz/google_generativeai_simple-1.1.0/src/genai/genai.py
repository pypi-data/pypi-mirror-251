"""This module simplifies the Google AI Studio implementation dramatically.
It also installs the needed modules.
"""

__version__ = "1.0"
__author__ = "Caden Kegg"
...
def run(input: str, api_key: str, prompt="default", defaults: dict = {}) -> str:
    ...
    if input == "Terminate(\"program\")":
        ...
        exit()
    if prompt == "default":
        prompt = """Answer the following query to the best of your ability\n""" # This essentially trains the model
    genai.configure(api_key=api_key)
