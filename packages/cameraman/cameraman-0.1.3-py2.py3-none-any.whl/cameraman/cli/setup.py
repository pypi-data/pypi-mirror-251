...
[Service]
ExecStart={virtualenv}/bin/python {virtualenv}/bin/{service_name} {command}
Environment="PATH={virtualenv}/bin"

ProtectHome=false
#WorkingDirectory=%h/workspace/{service_name} 
WorkingDirectory=/home/agp/workspace/{service_name} 
#Restart=always
Restart=no
RestartSec=5s
User=agp
