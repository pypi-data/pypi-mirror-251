...
from .configfile import Include
...
class ConfigManager:
	...
	def __init__(self, appname: str, version: str, doc: 'str|None') -> None:
		'''
	...
	def create_argument_parser(self) -> argparse.ArgumentParser:
		...
		by calling :meth:`~confattr.quickstart.ConfigManager.create_empty_argument_parser`, :meth:`~confattr.quickstart.ConfigManager.add_version_argument` and :meth:`~confattr.quickstart.ConfigManager.add_config_related_arguments`.
		'''
