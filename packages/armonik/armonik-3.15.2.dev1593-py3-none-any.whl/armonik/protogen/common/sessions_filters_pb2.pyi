...
class FilterStatus(_message.Message):
    ...
    value: _session_status_pb2.SessionStatus
    operator: _filters_common_pb2.FilterStatusOperator
    def __init__(self, value: _Optional[_Union[_session_status_pb2.SessionStatus, str]] = ..., operator: _Optional[_Union[_filters_common_pb2.FilterStatusOperator, str]] = ...) -> None: ...
