...
from .block import GenBlock, InputBlock, OutputBlock
from .functional import model_summary


class hVAE(nn.Module):
    def __init__(self, blocks: OrderedModuleDict, init: OrderedModuleDict = None):
