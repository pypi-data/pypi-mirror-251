...
async function activate(app, mainMenu, settings, launcher) {
    ...
    Promise.all([app.restored, settings.load(PLUGIN_ID)])
        .then(async ([, setting]) => {
        let loadedSettings = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.loadSettings)(setting);
    ...
    app.commands.addCommand(openChatlas, {
        ...
        execute: async () => {
            const content = new _widgets_ChatlasWidget__WEBPACK_IMPORTED_MODULE_8__.ChatlasWidget(atlasId, chatlasURL);
    ...
    app.commands.addCommand(getSupport, {
        ...
        execute: async () => {
            ...
            const content = new _widgets_GetSupportFormWidget__WEBPACK_IMPORTED_MODULE_9__.GetSupportFormWidget({ username: currentUser });
...
function loadSettings(setting) {
    ...
    let chatlasURL = setting.get('chatlasURL-asksmce').composite || "";
...
async function saveChatlasURL(setting, chatlasURL) {
    // Read the settings and convert to the correct type
    await setting.set('chatlasURL-asksmce', chatlasURL);
    return chatlasURL;
}
...
//# sourceMappingURL=lib_index_js.0e6441b8d9d80d900d53.js.map