...
class V3xAnalyzer(object):
    ...
    @staticmethod
    def parse_file(filename):
        return _libQasm.V3xAnalyzer_parse_file(filename)

    @staticmethod
    def parse_file_to_json(filename):
        return _libQasm.V3xAnalyzer_parse_file_to_json(filename)
    ...
    def analyze_file(self, filename):
        return _libQasm.V3xAnalyzer_analyze_file(self, filename)

    def analyze_file_to_json(self, filename):
        return _libQasm.V3xAnalyzer_analyze_file_to_json(self, filename)
