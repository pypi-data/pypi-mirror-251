...
def download_weights(model):
    weights = {
        ...
        'FastSAM': ['https://drive.google.com/u/0/uc?id=1m1sjY4ihXBU1fZXdQ-Xdj-mDltW-2Rqv&export=download&confirm=' \
                    't&uuid=bacf82f5-6461-44a5-8594-e534dd1b0509&at=AB6BwCD_YbFjLvGr0XiZVPtCQieh:1703072969660', 'FastSAM.pt']
    }
...
def choose_SAM_model(SAM_model):
    ...
    if not os.path.exists(os.path.join(directory, 'sam_vit_b_01ec64.pth')) and not os.path.exists(os.path.join(directory, 'sam_vit_l_0b3195.pth')) and not os.path.exists(os.path.join(directory, 'sam_vit_h_4b8939.pth')):
        ...
        _input = input('The huge weight is downloaded. Do you want to use it instead? y/n: ')
        if _input.lower() == 'y':
            return os.path.join(directory, 'sam_vit_h_4b8939.pth'), 'vit_h'
        else:
            return None
    elif os.path.exists(os.path.join(directory, 'sam_vit_l_0b3195.pth')):
        _input = input('The large weight is downloaded. Do you want to use it instead? y/n: ')
        if _input.lower() == 'y':
            return os.path.join(directory, 'sam_vit_l_0b3195.pth'), 'vit_l'
        else:
            return None
    elif os.path.exists(os.path.join(directory, 'sam_vit_b_01ec64.pth')):
        _input = input('The base weight is downloaded. Do you want to use it instead? y/n: ')
        if _input.lower() == 'y':
