...
def authorize_oauth1() -> gspread.client.Client:
    """
    Returns an authorize client, usiong the google.colab auth object and google.auth credentials
    Use when testing in Colab
    """
    ...
    google_client = gspread.Client(credentials)
