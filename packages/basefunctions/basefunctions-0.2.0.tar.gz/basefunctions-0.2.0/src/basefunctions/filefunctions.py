...
def check_if_exists(file_name, file_type="FILE"):
    """
...
def get_file_extension(path_file_name):
    """
...
def get_parent_path_name(path_file_name):
    """
...
def get_base_name(path_file_name):
    """
...
def get_base_name_prefix(path_file_name):
    """
...
def get_extension(path_file_name):
    """
...
def get_path_and_base_name_prefix(path_file_name):
    """
...
def set_current_directory(directory_name):
    """
...
def rename_file(src, target, overwrite=False):
    """Rename a file.
