...
class ProjectProject(object):
    ...
    @property
    def schedules(self):
        """Gets the schedules of this ProjectProject.  # noqa: E501

        List of Schedules that belong to the Project. Restricted to 1 Schedule per Project starting from version 2.6.  # noqa: E501

        :return: The schedules of this ProjectProject.  # noqa: E501
        :rtype: list[ProjectSchedule]
        """
        return self._schedules

    @schedules.setter
    def schedules(self, schedules):
        """Sets the schedules of this ProjectProject.

        List of Schedules that belong to the Project. Restricted to 1 Schedule per Project starting from version 2.6.  # noqa: E501

        :param schedules: The schedules of this ProjectProject.  # noqa: E501
        :type: list[ProjectSchedule]
        """
