...
class ProjectServiceApi(object):
    ...
    def project_service_create_schedule_for_project(self, body, project_id_uuid, **kwargs):  # noqa: E501
        """CreateScheduleForProject  # noqa: E501

        Create a Schedule for the Project to run tests automatically.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.project_service_create_schedule_for_project(body, project_id_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProjectIdUuidSchedulesBody body: (required)
        :param str project_id_uuid: Unique object ID. (required)
        :return: ProjectCreateScheduleForProjectResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.project_service_create_schedule_for_project_with_http_info(body, project_id_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.project_service_create_schedule_for_project_with_http_info(body, project_id_uuid, **kwargs)  # noqa: E501
            return data

    def project_service_create_schedule_for_project_with_http_info(self, body, project_id_uuid, **kwargs):  # noqa: E501
        """CreateScheduleForProject  # noqa: E501

        Create a Schedule for the Project to run tests automatically.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.project_service_create_schedule_for_project_with_http_info(body, project_id_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method project_service_create_schedule_for_project" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `project_service_create_schedule_for_project`")  # noqa: E501
        # verify the required parameter 'project_id_uuid' is set
        if ('project_id_uuid' not in params or
                params['project_id_uuid'] is None):
            raise ValueError("Missing the required parameter `project_id_uuid` when calling `project_service_create_schedule_for_project`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId.uuid}/schedules', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ProjectCreateScheduleForProjectResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def project_service_update_schedule_for_project(self, body, project_id_uuid, schedule_id_uuid, **kwargs):  # noqa: E501
        """UpdateScheduleForProject  # noqa: E501

        Updates a Schedule's editable fields.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.project_service_update_schedule_for_project(body, project_id_uuid, schedule_id_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param SchedulesScheduleIdUuidBody body: (required)
        :param str project_id_uuid: Unique object ID. (required)
        :param str schedule_id_uuid: Unique object ID. (required)
        :return: ProjectUpdateScheduleForProjectResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.project_service_update_schedule_for_project_with_http_info(body, project_id_uuid, schedule_id_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.project_service_update_schedule_for_project_with_http_info(body, project_id_uuid, schedule_id_uuid, **kwargs)  # noqa: E501
            return data

    def project_service_update_schedule_for_project_with_http_info(self, body, project_id_uuid, schedule_id_uuid, **kwargs):  # noqa: E501
        """UpdateScheduleForProject  # noqa: E501

        Updates a Schedule's editable fields.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.project_service_update_schedule_for_project_with_http_info(body, project_id_uuid, schedule_id_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method project_service_update_schedule_for_project" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `project_service_update_schedule_for_project`")  # noqa: E501
        # verify the required parameter 'project_id_uuid' is set
        if ('project_id_uuid' not in params or
                params['project_id_uuid'] is None):
            raise ValueError("Missing the required parameter `project_id_uuid` when calling `project_service_update_schedule_for_project`")  # noqa: E501
        # verify the required parameter 'schedule_id_uuid' is set
        if ('schedule_id_uuid' not in params or
                params['schedule_id_uuid'] is None):
            raise ValueError("Missing the required parameter `schedule_id_uuid` when calling `project_service_update_schedule_for_project`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId.uuid}/schedules/{scheduleId.uuid}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ProjectUpdateScheduleForProjectResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
