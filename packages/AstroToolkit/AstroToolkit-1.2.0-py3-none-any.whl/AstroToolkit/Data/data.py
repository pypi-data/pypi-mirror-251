...
'''
def get_survey_list():
	survey_list=['gaia','panstarrs','skymapper','galex','rosat','sdss','wise','twomass']
	return survey_list
...
def get_survey_times():
	survey_time_dict={'gaia':[2016,0],'panstarrs':[2012,0],'skymapper':[2016,0],'galex':[2007,0],'rosat':[1991,0],'sdss':[2017,0],'wise':[2010,5],'twomass':[1999,0],'ztf':[2019,0]}
