...
class TestServiceStub(betterproto.ServiceStub):
    ...
    async def validate_data_delivery_test(
        self,
        v2_catalog_create_data_delivery_request: "__v2_catalog__.CreateDataDeliveryRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            ...
            v2_catalog_create_data_delivery_request,
            TestResult,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class TestServiceBase(ServiceBase):
    ...
    async def __rpc_validate_data_delivery_test(
        self,
        stream: "grpclib.server.Stream[__v2_catalog__.CreateDataDeliveryRequest, TestResult]",
    ) -> None:
        request = await stream.recv_message()
        ...
        return {
            ...
            "/unacast.system.v1.TestService/ValidateDataDeliveryTest": (
                grpclib.const.Handler(
                    ...
                    grpclib.const.Cardinality.UNARY_UNARY,
                    __v2_catalog__.CreateDataDeliveryRequest,
                    TestResult,
                )
            ),
            "/unacast.system.v1.TestService/DeleteDeliveredBigQueryTable": (
