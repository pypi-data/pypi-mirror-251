...
from exclusiveAI.components import NeuralNetwork, exclusiveAIModel
...
class Composer:
    ...
    def compose(self, regression: bool = False, model=NeuralNetwork.NeuralNetwork) -> exclusiveAIModel:
        """
        Compose the building block to build the model.
        Returns:
