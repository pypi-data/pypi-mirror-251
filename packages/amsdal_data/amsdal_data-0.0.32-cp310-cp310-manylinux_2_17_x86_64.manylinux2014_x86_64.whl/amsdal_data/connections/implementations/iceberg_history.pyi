...
class IcebergHistoricalConnection(HistoricalConnectionBase):
    ...
    def __select_statement(self, select_only: str, table_name: str, main_table_name: str, metadata_join_table: str, conditions: Q | None = None, *, is_internal_table: bool) -> tuple[str, dict[str, Any]]: ...
