...
class Check1Stub(object):
    ...
    def __init__(self, channel):
        ...
        self.multiSubmitRules = channel.unary_unary(
                '/Check1/multiSubmitRules',
                request_serializer=th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesRequest.SerializeToString,
                response_deserializer=th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesResponse.FromString,
                )
...
class Check1Servicer(object):
    ...
    def multiSubmitRules(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_Check1Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'multiSubmitRules': grpc.unary_unary_rpc_method_handler(
                    servicer.multiSubmitRules,
                    request_deserializer=th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesRequest.FromString,
                    response_serializer=th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesResponse.SerializeToString,
            ),
    }
...
class Check1(object):
    ...
    def multiSubmitRules(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Check1/multiSubmitRules',
            th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesRequest.SerializeToString,
            th2__grpc__check1_dot_check1__pb2.MultiSubmitRulesResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
