...
@typing_extensions.final
class MultiSubmitRulesRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    RULES_FIELD_NUMBER: builtins.int
    OMIT_RESPONSE_FIELD_NUMBER: builtins.int
    @property
    def rules(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Rule]: ...
    omit_response: builtins.bool
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["omit_response", b"omit_response", "rules", b"rules"]) -> None: ...

global___MultiSubmitRulesRequest = MultiSubmitRulesRequest

@typing_extensions.final
class MultiSubmitRulesResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___MultiSubmitRulesResponse = MultiSubmitRulesResponse
