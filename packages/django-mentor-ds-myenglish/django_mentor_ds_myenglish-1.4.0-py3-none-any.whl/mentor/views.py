...
from _data import mentor_myenglish_contents
...
def home(request, lang=None):
    ...
    """
    if lang == 'kor':
        c = mentor_myenglish_contents.context_kor
        c['lang']['selected'] = 'kor'
    elif lang == 'eng':
        c = mentor_myenglish_contents.context_eng
        c['lang']['selected'] = 'eng'
    else:
        # 페이지 로딩시 초기 언어
        c = mentor_myenglish_contents.context_eng
    ...
    c['font_link'] = "https://fonts.googleapis.com/css2?" \
                     ...
                     "family=Gabarito:wght@400;500;600;700;800;900&" \
