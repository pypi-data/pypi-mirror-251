...
class _BaseReport:
    ...
    async def _get_classification_detail_view(self, perturbed_observation_id: int) -> widgets.VBox:
        ...
        original_inference = (
            await perturbed_obs_details.observation_inference_result_as_remote_file.fetch_remote_file()
        )
        perturbed_inference = (
            await perturbed_obs_details.perturbed_observation_inference_result_as_remote_file.fetch_remote_file()
        )
    ...
    async def _get_semantic_segmentation_detail_view(
        ...
        original_inference = (
            await adversarial_example_details.observation_inference_result_as_remote_file.fetch_remote_file()
        )
        perturbed_inference = (
            await adversarial_example_details.perturbed_observation_inference_result_as_remote_file.fetch_remote_file()
        )
    ...
    async def _get_object_detection_detail_view(
        ...
        perturbed_inference = (
            await artifact_details.perturbed_observation_inference_result_as_remote_file.fetch_remote_file()
        )
        ...
        observation_box_with_selector = display_selection_class_detection_widget(
            ...
            adversarial_example_image=perturbed_observation,
