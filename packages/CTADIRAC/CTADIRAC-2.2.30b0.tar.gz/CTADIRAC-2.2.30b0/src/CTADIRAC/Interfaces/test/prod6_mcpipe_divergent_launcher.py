...
def run_simulation(args):
    ...
    job.set_half_moon(
        half_moon=False
    )  # No half moon simulations with divergent pointing for now
    job.set_full_moon(
        full_moon=False
    )  # No full moon simulations with divergent pointing for now
    ...
    if mode == "WMS":
        ...
        trans_name = "Prod6_divergent_{}_{}_{}_{}_{}_{}".format(
            job.cta_site,
            job.particle,
            job.pointing_dir,
            job.zenith_angle,
