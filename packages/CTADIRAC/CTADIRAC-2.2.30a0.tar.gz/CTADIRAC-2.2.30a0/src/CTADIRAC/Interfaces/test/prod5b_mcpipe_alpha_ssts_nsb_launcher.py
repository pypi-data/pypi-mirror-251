...
from CTADIRAC.Interfaces.API.Prod5bMCPipeAlphaSSTsNSBJob import (
    Prod5bMCPipeAlphaSSTsNSBJob,
)
...
def submit_transformation(job, trans_name):
    ...
    trans.setLongDescription(
        "Prod5 simulation pipeline Alpha SST-only NSB"
    )  # mandatory
...
def run_simulation(args):
    ...
    if mode == "WMS":
        ...
        trans_name = "Prod5b_SSTOnly_Alpha_{}_{}_{}_{}{}".format(
            job.cta_site,
            job.particle,
            job.pointing_dir,
            job.zenith_angle,
