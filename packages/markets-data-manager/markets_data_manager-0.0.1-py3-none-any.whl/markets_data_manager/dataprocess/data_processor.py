...
import pandas as pd
from datareader.data_reader import DataReader, DateRangeDataReader
...
from calculations.equity import LowestPriceInNextNDaysCalculationWorker, HighestPriceInNextNDaysCalculationWorker
