...
from hpformula import *  # 使用HP_formula公式基本函数库
    ...
    def Callback(self, event):
        ...
        if self.picture != '':
            if self.zoom:
                ...
                self.tk_image = tkinter.PhotoImage(self.pil_image2)
...
class ToolsBar(tk.Frame):
    def __init__(self, root, n=3, **kw):
        ...
        if self.m < 0:
            self.m = 1
        png=r"D:/UserData/Documents/@Python2022/@cy/img/up.png"
        self.t = []
        self.t1 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t2 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t3 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t4 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t4 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t5 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t6 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t7 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t8 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t9 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t10 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t11 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t12 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t13 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t14 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t15 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t16 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t17 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t18 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t19 = ttk.Button(self, width=20, command=None, cursor='hand2')
        self.t20 = ttk.Button(self, width=20, command=None, cursor='hand2')
...
class useredit2(tk.Frame):  # 继承Frame类
    ...
    def Init(self):
        ...
        self.toolbar = tk.Frame(self.root, height=20)
        self.toolbarName = (
        '清空窗口', '打开', '保存', '另存', '取消', '重做', '剪切', '复制', '粘贴', '选择全部', '外部运行', '内部运行', '字缩小', '字放大', '背景色', '字体色')
        self.toolbarCommand = (self.newfile, self.openfile, self.savefile, self.saveas, self.undo, self.redo, self.cut,
                               self.copy, self.paste, self.selectall, self.runuc3, self.runuc, self.font2, self.font3,
                               self.setbg, self.setfg)
        ...
        self.newfile, self.openfile, self.savefile, self.saveas, self.undo, self.redo, self.cut, self.copy, self.paste,
        self.selectall, self.runuc, self.font2, self.font3)
        ...
        self.label = tk.Label(self.statusbar, anchor=tk.E, height=1, text='Ln', relief=tk.FLAT, takefocus=False,
                              textvariable=self.var, padx=2)
...
class gridFramejq(Frame):  # 继承Frame类
    ...
    def rxt(self):
        ...
        if g.login:
            ...
            df3 = jq.get_price(g.stock, start_date=g.sday, end_date=g.eday,
    ...
    def createPage(self):
        ...
        def flash():
            ...
            for i in range(len(self.df)):
                self.tree.insert('', i, values=[self.df.name[i], self.df.open[i], self.df.close[i], self.df.high[i],
                                                self.df.low[i], self.df.volume[i]])
        ...
        for i in range(len(df4)):
            self.tree.insert('', i, values=[df4.jkname[i], df4.display_name[i], df4.name[i], df4.start_date[i],
                                            df4.end_date[i], df4.type[i]])
...
class ClosableNotebook(ttk.Notebook):
    ...
    def _check_update_style(self):
        ...
        if "img_close" not in self.image_names():
            ClosableNotebook._close_img = tk.PhotoImage("img_tab_close", data=((
                                                                                           "R0lGODdhDgAKAIcAAMbGxrG1sbGksZ2knQ" + "A" * 1007 + "CwAAAAADgAKAAAIRwABCBxIsKDBgwMDAFgIIACAhxAhCgAAQACAixgzAhAQAIDHjyA9BhgAoKTJkwAEAAAQAIDLly8DAJgJQACAmzhz6tzJU2dAADs=").encode()))
            ClosableNotebook._close_active_img = tk.PhotoImage("img_tab_close_active", data=((
                                                                                                         "R0lGODdhDgAKAIcAAMbGxmBgY" + "A" * 1016 + "CwAAAAADgAKAAAIRwABCBxIsKDBgwMDAFgIIACAhxAhBgAAIACAixgzAggQAIDHjyA9BggAoKTJkwACAAAQAIDLly8DAJgJIACAmzhz6tzJU2dAADs=").encode()))
