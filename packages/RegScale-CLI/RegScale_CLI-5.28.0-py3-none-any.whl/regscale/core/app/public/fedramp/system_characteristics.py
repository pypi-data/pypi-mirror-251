    ...
    for additional_identifier in additional_identifiers:
        try:
            if additional_identifier.attrib["identifier-type"] == "https://fedramp.gov":
                pass  # already accounted for FedRAMP assigned system ID but will show up in these find results
            else:
                property_ = {}
                property_["key"] = (
                    "identifier-type=" + additional_identifier.attrib["identifier-type"]
                )
                property_["value"] = additional_identifier.text
                property_["label"] = "Other System ID"
                property_["otherAttributes"] = xpath_query.replace(
