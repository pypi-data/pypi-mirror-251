...
def create_new_data_submodule(
    ...
    :param str raw_data: Raw data to upload
    :param bool is_file: Boolean to indicate if the file is a file or a directory
...
def create_properties(
    ...
    :param int retries: Number of times to retry the API call if it fails, defaults to 3
    :param str label: Label to use for the properties, defaults to None
