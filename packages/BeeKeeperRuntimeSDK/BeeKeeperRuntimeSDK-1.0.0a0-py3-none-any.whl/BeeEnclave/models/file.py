...
class File(BaseModel):
    ...
    File
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the file")
    ...
    upload_date: Optional[datetime] = Field(default=None, description="Date and time the file was uploaded", alias="uploadDate")
