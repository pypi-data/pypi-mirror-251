...
class SQLResponse(BaseModel):
    ...
    SQLResponse
    """ # noqa: E501
    results: Optional[List[Dict[str, Any]]] = Field(default=None, description="Results of the SQL query in a JSON format")
    message: Optional[StrictStr] = Field(default=None, description="Additional information about the query execution, e.g., if there were any errors")
