...
class ValidationResult(BaseModel):
    ...
    ValidationResult
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The status of the validation. E.g., \"failed\" or \"successful\".")
    message: Optional[Dict[str, List[StrictStr]]] = Field(default=None, description="Object with validation error messages if any.")
