...
def main(
    ...
    if is_obfuscation_required and is_obfuscation_proof_required:
        for vuln_file in vuln_files:
...
def _validations(
    ...
    if platform_client is not None and (platform_url is not None or local_repo.remote_url is not None):
        platform_client.set_url(platform_url or local_repo.remote_url)
