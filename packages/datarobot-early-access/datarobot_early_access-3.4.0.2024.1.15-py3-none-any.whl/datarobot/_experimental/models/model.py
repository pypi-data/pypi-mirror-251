...
class Model(datarobot_model):  # pylint: disable=missing-class-docstring
    ...
    def get_incremental_learning_metadata(self, project_id, id1, _client):
        """
        ...
        """
        url = "projects/{}/models/{}/incrementalLearningMetadata/".format(project_id, id1)
        server_data = _client.get(url).json()
        server_data["projectId"] = project_id
        server_data["modelId"] = id1
