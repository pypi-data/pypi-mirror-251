...
def generate_advanced_analytics(df, client_logo, report_filename, configpath, filename):
    ...
    #TODO: new report api had to remove: 'failureReasonName': 'Custom Failure Reasons', 
    profile_df.rename(columns={'name': 'Test Name', 'owner': 'Test Owner', 'message': 'Test Failure Message','failureReason/name': 'Custom Failure Reason',
