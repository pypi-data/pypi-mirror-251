...
class Build(object):
    ...
    def __init__(self, application_template_id=None, config_json=None, id=None, revision=None, creator_id=None, docker_image_name=None, error_message=None, status=None, created_at=None, last_modified_at=None, deleted_at=None, is_byod=None, registry_login_secret=None, local_vars_configuration=None):  # noqa: E501
