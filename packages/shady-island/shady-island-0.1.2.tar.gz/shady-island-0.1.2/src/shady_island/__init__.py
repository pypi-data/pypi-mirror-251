...
class DeploymentTierStage(
    ...
    def __init__(
        ...
        *,
        ...
        :param context_file: The filesystem path to a JSON file that contains context values to load. Using this property allows you to load different context values within each instantiated ``DeploymentTierStage``, directly from a file you can check into source control.
...
class DeploymentTierStageProps(_aws_cdk_ceddda9d.StageProps):
    def __init__(
        self,
        *,
        env: typing.Optional[typing.Union[_aws_cdk_ceddda9d.Environment, typing.Dict[builtins.str, typing.Any]]] = None,
