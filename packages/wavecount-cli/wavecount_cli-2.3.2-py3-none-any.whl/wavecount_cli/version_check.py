...
def compare():
    ...
    try:
        ...
        for i in range(len(current_version)):
            if latest_version[i] > current_version[i]:
                ...
                hint_msg = (
                    ...
                    + click.style(
                        "pip3 install --upgrade {} ".format(PACKAGE_NAME), fg="blue"
                    )
        ...
        spinner.fail(text="oops!! Update Checking Timeout Error")
        return
    except requests.RequestException as e:
        spinner.fail(text="oops!! Update Checking General Error")
        exit()
    except KeyboardInterrupt:
        spinner.fail(text="Update Checking Someone Closed")
