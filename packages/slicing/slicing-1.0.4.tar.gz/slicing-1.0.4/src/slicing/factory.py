...
if __name__ == '__main__':
    ...
    # tid = SliceFactory.slice(Path("D:\\workspace\\Resources\\eclinical_design_dev_27_20220822084120.zip"), Path("YYYYY"))
    # tid = SliceFactory.slice(absolute_file_path=Path("D:\\workspace\\Resources\\eclinical_edc_prod_21_20230630025243.sql"),
    # tid = SliceFactory.slice(absolute_file_path=Path("D:\\workspace\\Resources\\eclinical_edc_prod_21_20230630025243.sql.gz"),
    #                    absolute_out_put_folder=Path("YYYYY"))
    # tid = SliceFactory.slice(Path("D:\\workspace\\Resources\\eclinical_iwrs_prod_113_20240113.sql"), Path("YYYYY"))
    us_path = Path("D:\\aws\\eclinical40-document\\release\\uat-us\\20240107")
    # path = us_path.joinpath(Path("V75_initial_edc\\edc\\V75__edc_business_schema_initial_sql.sql"))
    # path = us_path.joinpath(Path("V31_incremental_ctms\\ctms\\V31__ctms_business_schema_incremental_sql.sql"))
    # path = us_path.joinpath(Path("V31_initial_ctms\\ctms\\V31__ctms_business_schema_initial_sql.sql"))
    # path = us_path.joinpath(Path("V8_initial_pv\\pv\\V8__pv_business_schema_initial_sql.sql"))
    # path = us_path.joinpath(Path("V29_initial_etmf\\etmf\\V29__etmf_business_schema_initial_sql.sql"))
    # path = us_path.joinpath(Path("V1_initial_coding_study\\coding\\V1__coding_study_business_schema_initial_sql.sql"))
    path = us_path.joinpath(Path("V75_incremental_edc\\edc\\V75__edc_business_schema_incremental_sql.sql"))
