...
class ClassificationClient:
    ...
    def classify_image_file(self) -> Classification:
        """
        Classify an image file for specific concepts ids or all concepts within a dataset
...
class AsyncClassificationClient:
    ...
    async def classify_image_file(self) -> Classification:
        """
        Classify an image file for specific concepts ids or all concepts within a dataset
