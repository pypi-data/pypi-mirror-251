...
with empire_platform_api_public_client.ApiClient(configuration) as api_client:
    ...
    timescale = empire_platform_api_public_client.AuctionTimescale() # AuctionTimescale | Auction Timescale (optional) (optional)
    ...
    try:
        api_response = api_instance.get_aggregated_allocated_auctions(border_direction=border_direction, timescale=timescale, product_types=product_types, x_participant_id=x_participant_id, participant_status=participant_status, delivery_period_start=delivery_period_start, delivery_period_end=delivery_period_end)
