...
class SparkJobInstance:
    ...
    def list_spark_job_instances(workspace_id, page_number, limit, cluster_id=None, job_conf_id=None, job_conf_name=None, job_status=None):
        try:
    ...
    def search_spark_job_instance_by_workspaceId_and_name(workspace_id, job_id, pageNumber, limit):
        try:
