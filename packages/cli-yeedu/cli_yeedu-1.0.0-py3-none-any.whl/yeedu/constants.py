...
COMPUTE_TYPES_LIST = ['compute_optimized', 'memory_optimized',
                      'general_purpose', 'storage_optimized', 'gpu_accelerated']
...
# JOB TYPE lang
JOB_TYPE_LIST = ['Raw Scala', 'Jar', 'Python3', 'SQL']
...
CLUSTER_INSTANCE_USERS_ORDER = ['auth_engine_cluster_instance_user_id', 'engine_cluster_instance',
                                'engine_cluster_instance_perm', 'user', 'created_by', 'modified_by', 'last_update_date', 'from_date', 'to_date']
