...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event() != 47519:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder() != 13918:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder_to() != 47904:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_shutdown() != 18928:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_signer() != 57777:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_clientbuilder_opts() != 13520:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_clientbuilder_signer() != 39026:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nip46signer_relay_url() != 34734:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nip46signer_signer_public_key() != 56148:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayconnectionstats_uptime() != 18216:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_client_new() != 28400:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_client_with_opts() != 54987:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_clientbuilder_new() != 53242:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_keys() != 57808:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_nip46() != 46208:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nip46signer_new() != 14708:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_clientsigner.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_clientsigner.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_clientsigner.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_clientsigner.restype = None
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_keys.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_keys.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_nip46.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_nip46.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nip46signer_signer_public_key.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_keys.argtypes = (
)
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_keys.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_nip46.argtypes = (
)
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_clientsigner_nip46.restype = ctypes.c_uint16
...
class ClientProtocol(typing.Protocol):
    ...
    def send_event_builder(self, builder: "EventBuilder"):
        ...
        raise NotImplementedError
    def send_event_builder_to(self, url: "str",builder: "EventBuilder"):
        """
...
class Client:
    ...
    _pointer: ctypes.c_void_p
    def __init__(self, signer: "typing.Optional[ClientSigner]"):
        _UniffiConverterOptionalTypeClientSigner.check_lower(signer)
        
        self._pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_client_new,
        _UniffiConverterOptionalTypeClientSigner.lower(signer))
    ...
    @classmethod
    def with_opts(cls, signer: "typing.Optional[ClientSigner]",opts: "Options"):
        _UniffiConverterOptionalTypeClientSigner.check_lower(signer)
    ...
    def send_event_builder_to(self, url: "str",builder: "EventBuilder") -> "EventId":
        """
        Take an [`EventBuilder`], sign it by using the [`ClientSigner`] and broadcast to specific relays.
    ...
    def signer(self, ) -> "ClientSigner":
        return _UniffiConverterTypeClientSigner.lift(
            _rust_call_with_error(
...
class ClientBuilderProtocol(typing.Protocol):
    ...
    def opts(self, opts: "Options"):
        ...
        raise NotImplementedError
    def signer(self, signer: "ClientSigner"):
        raise NotImplementedError
...
class ClientBuilder:
    ...
    def signer(self, signer: "ClientSigner") -> "ClientBuilder":
        _UniffiConverterTypeClientSigner.check_lower(signer)
        
        return _UniffiConverterTypeClientBuilder.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_clientbuilder_signer,self._uniffi_clone_pointer(),
        _UniffiConverterTypeClientSigner.lower(signer))
        )
...
class ClientSignerProtocol(typing.Protocol):
    pass
...
class ClientSigner:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_clientsigner, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_clientsigner, self._pointer)
    ...
    def keys(cls, keys: "Keys"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_keys,
    ...
    def nip46(cls, nip46: "Nip46Signer"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_clientsigner_nip46,
        _UniffiConverterTypeNip46Signer.lower(nip46))
        return cls._make_instance_(pointer)


class _UniffiConverterTypeClientSigner:

    @staticmethod
    def lift(value: int):
        return ClientSigner._make_instance_(value)

    @staticmethod
    def check_lower(value: ClientSigner):
        if not isinstance(value, ClientSigner):
            raise TypeError("Expected ClientSigner instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: ClientSignerProtocol):
        if not isinstance(value, ClientSigner):
            raise TypeError("Expected ClientSigner instance, {} found".format(type(value).__name__))
        return value._uniffi_clone_pointer()
    ...
    @classmethod
    def write(cls, value: ClientSignerProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))
...
class Nip46Signer:
    ...
    _pointer: ctypes.c_void_p
    def __init__(self, relay_url: "str",app_keys: "Keys",signer_public_key: "typing.Optional[PublicKey]"):
    ...
    def signer_public_key(self, ) -> "typing.Optional[PublicKey]":
        """Get signer [`XOnlyPublicKey`]"""
...
class _UniffiConverterOptionalTypeClientSigner(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        if value is not None:
            _UniffiConverterTypeClientSigner.check_lower(value)
    ...
    def write(cls, value, buf):
        ...
        buf.write_u8(1)
        _UniffiConverterTypeClientSigner.write(value, buf)
    ...
    def read(cls, buf):
        ...
        if flag == 0:
            ...
            return _UniffiConverterTypeClientSigner.read(buf)
        else:
            raise InternalError("Unexpected flag byte for optional type")
