...
For more information about all of the possible configuration values visit our [documentation page](https://docs.covalent.xyz/user-documentation/api-reference/executors/oci/#overview-of-configuration) for this plugin.
...
Covalent's [resource deployment](https://docs.covalent.xyz/docs/user-documentation/how-to/resource-deployment) feature is very convenient for auto-creating these resources:

```bash
covalent deploy up awsbatch
```

For more information, see our [documentation page](https://docs.covalent.xyz/user-documentation/api-reference/executors/oci/#required-cloud-resources) for this plugin.
