...
class ServiceRequestRecordOp(_ods_ir.OpView):
  ...
  def __init__(self, requestor, servicePort, direction, bundleType, *, stdService=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def manifest_req(requestor, service_port, direction, bundle_type, *, std_service=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ServiceRequestRecordOp(requestor=requestor, servicePort=service_port, direction=direction, bundleType=bundle_type, stdService=std_service, loc=loc, ip=ip))
