...
def __get_cmd_par():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "h", ["app=","modular=","plug=","user=","pwd=","host=","port=","timeout=","processcount="
        ...
        return {
            'server':server,
            'appname':appname,'modular':modular,'username':username,'password':password,'plug':plug,'host':host,'port':port,'timeout':timeout,'processcount':processcount,
