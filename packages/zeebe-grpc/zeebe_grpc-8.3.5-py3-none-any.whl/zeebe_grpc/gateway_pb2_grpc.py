...
class GatewayStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamActivatedJobs = channel.unary_stream(
                ...
                request_serializer=zeebe__grpc_dot_gateway__pb2.StreamActivatedJobsRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.ActivatedJob.FromString,
                )
        ...
        self.EvaluateDecision = channel.unary_unary(
                ...
                request_serializer=zeebe__grpc_dot_gateway__pb2.EvaluateDecisionRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.EvaluateDecisionResponse.FromString,
                )
        ...
        self.ModifyProcessInstance = channel.unary_unary(
                ...
                request_serializer=zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceResponse.FromString,
                )
        self.DeleteResource = channel.unary_unary(
                '/gateway_protocol.Gateway/DeleteResource',
                request_serializer=zeebe__grpc_dot_gateway__pb2.DeleteResourceRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.DeleteResourceResponse.FromString,
                )
        self.BroadcastSignal = channel.unary_unary(
                '/gateway_protocol.Gateway/BroadcastSignal',
                request_serializer=zeebe__grpc_dot_gateway__pb2.BroadcastSignalRequest.SerializeToString,
                response_deserializer=zeebe__grpc_dot_gateway__pb2.BroadcastSignalResponse.FromString,
                )
...
def add_GatewayServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamActivatedJobs': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.StreamActivatedJobsRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.ActivatedJob.SerializeToString,
            ),
            ...
            'EvaluateDecision': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.EvaluateDecisionRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.EvaluateDecisionResponse.SerializeToString,
            ),
            ...
            'ModifyProcessInstance': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceResponse.SerializeToString,
            ),
            'DeleteResource': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteResource,
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.DeleteResourceRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.DeleteResourceResponse.SerializeToString,
            ),
            'BroadcastSignal': grpc.unary_unary_rpc_method_handler(
                    servicer.BroadcastSignal,
                    request_deserializer=zeebe__grpc_dot_gateway__pb2.BroadcastSignalRequest.FromString,
                    response_serializer=zeebe__grpc_dot_gateway__pb2.BroadcastSignalResponse.SerializeToString,
            ),
    }
...
class Gateway(object):
    ...
    def StreamActivatedJobs(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/gateway_protocol.Gateway/StreamActivatedJobs',
            zeebe__grpc_dot_gateway__pb2.StreamActivatedJobsRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.ActivatedJob.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def EvaluateDecision(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/EvaluateDecision',
            zeebe__grpc_dot_gateway__pb2.EvaluateDecisionRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.EvaluateDecisionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ModifyProcessInstance(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/ModifyProcessInstance',
            zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.ModifyProcessInstanceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteResource(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/DeleteResource',
            zeebe__grpc_dot_gateway__pb2.DeleteResourceRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.DeleteResourceResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def BroadcastSignal(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/gateway_protocol.Gateway/BroadcastSignal',
            zeebe__grpc_dot_gateway__pb2.BroadcastSignalRequest.SerializeToString,
            zeebe__grpc_dot_gateway__pb2.BroadcastSignalResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
