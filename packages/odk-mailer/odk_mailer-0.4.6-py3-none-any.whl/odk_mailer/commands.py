from odk_mailer.lib import parser, prompts, utils, globals, smtp, db, log
...
# def config():
#     config = Config()
#     print(f"Your environment includes following variables: {vars(config)}")
#     config_answers = prompts.prompt_config()

#     if config_answers['confirm']:
#         print("Setting new config..")
#         os.environ['SMTP_HOST'] = config_answers["smtp_host"]
#         os.environ['SMTP_PORT'] = config_answers["smtp_port"]
#         os.environ['ODK_HOST'] = config_answers["odk_host"]

#         print(os.getenv('SMTP_HOST'))

#         new_config = Config()

#         print(f"Your environment includes following variables: {vars(new_config)}")