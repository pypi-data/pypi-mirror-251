...
#                          message="Do you want edit the configuration of ODK-Mailer?",                         
#         ),
#         inquirer.Text('smtp_host',
#                         message="Input smtp_host variable:",
#                         default=os.getenv('SMTP_HOST') or "smtp.freesmtpservers.com",
#                         ignore=lambda x: x["confirm"] != True
#         ),
#          inquirer.Text('smtp_port',
#                         message="Input smtp_host variable:",
#                         default=os.getenv('SMTP_PORT') or "25",
#                         ignore=lambda x: x["confirm"] != True
#         ),
#         inquirer.Text('odk_host',
#                         message="Input smtp_host variable:",
#                         default=os.getenv('ODK_HOST') or "https://odk.central.tld",
#                         ignore=lambda x: x["confirm"] != True
#         )        
#     ]
