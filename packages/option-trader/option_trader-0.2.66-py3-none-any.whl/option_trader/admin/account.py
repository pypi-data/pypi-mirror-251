        ...
        if app_settings.DATABASES == 'sqlite3':
            try:
                ...
                if os.path.exists(self.db_path) : 
                    ...
                    #self.asset_value      = self.get_asset_value()
...
#                cursor.execute(sql)  
    ...
    def get_cash_position(self):
        ...
        if 'IB' in self.brokerage:
            try:
                ...
                if df.shape[0] == 0:
                    self.logger.warning("No daily assount summary found")
                    return np.nan
    ...
    def trade_strategy(self, watchlist=[], strategy_list=[]):   
        ...
        for exp_date in exp_date_list:
            ...
            for i, opt in targets.iterrows():  
                ...
                if strategy == st.SHORT_PUT:
                    ...
                    if (cash_avail - opt[pscl.MAX_RISK]) / init_balance <  self.risk_mgr.min_cash_percent:
        ...
        print('position %d selected %d created' % (pos_selected, len(trade_rec_list)))
...
if __name__ == '__main__':
    ...
    #print('cash position', DU8147717_acct.get_cash_position())
    #print('margin position', DU8147717_acct.get_margin_position())
    #print('asset value',U11921459_acct.get_asset_value())    
    #print('cash position', U11921459_acct.get_cash_position())
    #print('margin position',U11921459_acct.get_margin_position())
    #print('pl',U11921459_acct.get_pl())


    print('asset value',DU8147717_acct.get_asset_value())    
    print('cash position', DU8147717_acct.get_cash_position())
    print('margin position',DU8147717_acct.get_margin_position())
    print('pl',DU8147717_acct.get_pl())
