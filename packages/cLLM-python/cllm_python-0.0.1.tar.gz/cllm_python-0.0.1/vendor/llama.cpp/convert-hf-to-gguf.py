...
def main() -> None:
    ...
    if args.awq_path:
        ...
        tmp_checkpoint_path = args.model / "weighted_model"
        dir_model = tmp_checkpoint_path
        if tmp_checkpoint_path.is_dir():
            print(f"{tmp_checkpoint_path} exists as a weighted model.")
        else:
            tmp_checkpoint_path.mkdir(parents=True, exist_ok=True)
            print("Saving new weighted model ...")
            add_scale_weights(str(args.model), str(args.awq_path), str(tmp_checkpoint_path))
            print(f"Saved weighted model at {tmp_checkpoint_path}.")
