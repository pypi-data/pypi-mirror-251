...
def test_comp():
    ...
    obj      = builder(dset='2018', trigger='ETOS', q2bin='high', vers='v7', const=False)
...
def test_cache():
    ...
    obj            = builder(dset='2018', trigger='ETOS', q2bin='high', vers='v5', const=False)
    obj.cache_path = 'tests/cache/cb_builder.tar.gz'
    pdf_ss         = obj.get_pdf(obs=obs, unc=  0, preffix='comp_ss')
