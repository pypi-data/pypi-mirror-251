...
class Bot(_main_bot):  # type: ignore
    """The aenoxiccord bot class. This is a subclass of :class:`discord.Bot` if you use Pycord.
    ...
    **kwargs:
    ...
    def add_help_command(
        ...
        **kwargs: Callable | str,
        ...
        embed:
            ...
            embed will be used.
            All template variables that are listed in :meth:`aenoxiccord.emb.set_embed_templates`
            can be used here.
        show_categories:
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxiccord.cogs.pyc.help_setup", package="aenoxiccord")
    ...
    def add_status_changer(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxiccord.cogs.pyc.status_changer_setup", package="aenoxiccord")
    ...
    def add_blacklist(
        ...
        **kwargs:
        ...
        if not DPY:
            self.load_extension("aenoxiccord.cogs.pyc.blacklist_setup", package="aenoxiccord")
    ...
    async def setup_hook(self):
        ...
        for ext in self.enabled_extensions:
            await self.load_extension(f".cogs.dpy.{ext}_setup", package="aenoxiccord")
...
class PrefixBot(Bot, commands.Bot):
    ...
    This class can be used if you want to use aenoxiccord with prefix commands.
...
class BridgeBot(Bot, bridge.Bot):
    ...
    This class can be used if you want to use aenoxiccord with bridge commands.
    This is only needed for Pycord.
    """
