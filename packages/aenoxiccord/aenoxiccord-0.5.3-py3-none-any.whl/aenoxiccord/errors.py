...
class aenoxiccordException(Exception):
    """Base exception class for all aenoxiccord exceptions."""


class ConvertTimeError(aenoxiccordException):
    """Raised when a time conversion fails."""


class Blacklisted(aenoxiccordException):
