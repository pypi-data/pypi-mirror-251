...
async def convert_png_to_mp4(BOT_TID, input_name, output_name, MEDIA_D):
    result = None
    try:
        tmp_gif = os.path.join(MEDIA_D, str(BOT_TID), datetime.datetime.utcnow().strftime(f'%d-%m-%Y_%H-%M-%S-%f.gif'))
