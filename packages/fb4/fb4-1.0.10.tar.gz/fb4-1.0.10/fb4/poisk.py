...
def info(arg='Q4'):
    ...
    if arg == 'Q1':
        ...
        15: Рао-Крамера для распределения Бернулли
        16: несмещенность, сост и эффективность выборочного среднего
        17: Рао-Крамера для распределения Пуассона
        18: Рао-Крамера для Биномиального распределения
        19: информационное неравенство Рао–Крамера
        20: информация по Фишеру
