SDK_INIT_ERROR = \
    'signalsdk::Please initialize Signal Application SDK first!'
SDK_APP_ID_NOT_FOUND_ERROR = \
    'signalsdk::Application Id not found on environment!'
SDK_APP_LOCAL_HTTP_SERVER_ERROR = \
    "signalsdk::Local HTTP server is not responding!"
...
SDK_APP_LOCAL_MQTT_CONNECT_ERROR = \
    "signalsdk::local mqtt connect threw an error"
SDK_APP_LOCAL_MQTT_PUBLISH_ERROR = \
    "signalsdk::local mqtt publish threw an error"
SDK_APP_LOCAL_MQTT_SUBSCRIBE_ERROR = \
    "signalsdk::local mqtt subscribe threw an error"
