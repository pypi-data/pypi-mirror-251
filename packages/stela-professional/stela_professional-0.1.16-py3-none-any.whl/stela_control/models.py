...
class Booking(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('booking-control/', kwargs={'pk': self.pk})
...
class TaxReturn(models.Model):
    ...
    status = models.CharField(max_length=10, choices=STATUS, default="Pending")
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, null=True, related_name='tax_returns')
