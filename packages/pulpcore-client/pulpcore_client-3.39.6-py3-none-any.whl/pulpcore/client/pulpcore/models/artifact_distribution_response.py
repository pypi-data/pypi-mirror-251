...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_url=None, base_path=None, name=None, pulp_href=None, hidden=False, content_guard=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
