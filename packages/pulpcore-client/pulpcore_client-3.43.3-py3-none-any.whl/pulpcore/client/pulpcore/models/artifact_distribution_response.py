...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, name=None, base_url=None, content_guard=None, base_path=None, pulp_created=None, pulp_href=None, hidden=False, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
