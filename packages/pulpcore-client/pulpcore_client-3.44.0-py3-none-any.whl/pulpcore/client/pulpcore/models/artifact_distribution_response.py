...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, pulp_labels=None, hidden=False, pulp_created=None, base_url=None, name=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
