...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_url=None, name=None, pulp_labels=None, content_guard=None, pulp_href=None, base_path=None, hidden=False, local_vars_configuration=None):  # noqa: E501
