...
class DiscoverRequest(_message.Message):
    __slots__ = ("type", "service", "Filter", "service_contract")
    ...
    SERVICE_CONTRACT_FIELD_NUMBER: _ClassVar[int]
    type: DiscoverRequest.DiscoverRequestType
    service: _service_pb2.Service
    Filter: DiscoverFilter
    service_contract: _contract_pb2.ServiceContract
    def __init__(self, type: _Optional[_Union[DiscoverRequest.DiscoverRequestType, str]] = ..., service: _Optional[_Union[_service_pb2.Service, _Mapping]] = ..., Filter: _Optional[_Union[DiscoverFilter, _Mapping]] = ..., service_contract: _Optional[_Union[_contract_pb2.ServiceContract, _Mapping]] = ...) -> None: ...
