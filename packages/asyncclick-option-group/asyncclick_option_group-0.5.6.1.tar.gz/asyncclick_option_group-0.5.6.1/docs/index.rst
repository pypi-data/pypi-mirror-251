...
**asyncclick-option-group** is an anyio-ized fork that interoperates
with `AsyncClick <https://github.com/python-trio/asyncclick>`_.

The rest of the documentation is unmodified, except for the occasional
...
.. code-block:: python
    ...
    from asyncclick_option_group import optgroup
