...
class Namespace(
    RootResource[Organization | Project | Domain | NamespaceType],
    kind='Namespace',
    version='namespaces/v1'
):
    ...
    @classmethod
    def factory(cls, type: str, name: str, **extra: Any):
        params: dict[str, Any] = {
            'metadata': {
                'name': name
            },
        ...
        return cls.model_validate({**extra, **params})
