...
class PixelsUser:
    ...
    def add_to_bookmarks(self):
        ...
        looking_for_sign = self.find_first_pixel(self.COLORS["land_sign_color"])
        print(bool(looking_for_sign))
        print(looking_for_sign)
        if looking_for_sign:
            "Entered the if statment"
            ...
            raise Exception("Entered the else statement, Was unable to add to bookmarks")
            sleep(2)
            pyautogui.hotkey("esc")
