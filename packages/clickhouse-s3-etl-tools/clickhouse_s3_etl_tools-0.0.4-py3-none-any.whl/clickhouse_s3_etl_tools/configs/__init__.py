...
MAX_TABLE_SIZE_TO_DROP_TABLE_MB = int(os.getenv("MAX_TABLE_SIZE_TO_DROP_TABLE_MB") or 1000)
...
MAX_PARTITIONS_PER_INSERT_BLOCK = int(os.getenv("MAX_PARTITIONS_PER_INSERT_BLOCK") or 500)
DELAY_BETWEEN_DROP_PARTITIONS_SEC = int(os.getenv("DELAY_BETWEEN_DROP_PARTITIONS") or 10)
