...
class Cluster(DistributedCluster, Generic[IsAsynchronous]):
    ...
    def __init__(
        ...
        *,
        ...
        self.init_time = datetime.datetime.now(tz=datetime.UTC)
...
If that does not solve your issue, please contact support@coiled.io.""")
    ...
    def _as_json_compatible(self):
        ...
        return {
            ...
            "cluster_object_life": str(datetime.datetime.now(tz=datetime.UTC) - self.init_time),
        }
    ...
    async def _wait_until_ready(self, is_new_cluster: bool) -> None:
        ...
        timeout_at = (
            datetime.datetime.now(tz=datetime.UTC) + datetime.timedelta(seconds=self.timeout)
        ...
        with ctx:
            while True:
                ...
                if scheduler_ready and enough_workers_ready:
                    ...
                    elif timeout_at is not None and datetime.datetime.now(tz=datetime.UTC) > timeout_at:
