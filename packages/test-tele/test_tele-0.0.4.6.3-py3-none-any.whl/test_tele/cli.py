...
def main(
    ...
    if mode == Mode.PAST:
        ...
        from test_tele.live import start_sync, run_pyrogram  # pylint: disable=import-outside-toplevel
        ...
        task1 = loop.create_task(start_sync())
        task2 = loop.create_task(run_pyrogram())
