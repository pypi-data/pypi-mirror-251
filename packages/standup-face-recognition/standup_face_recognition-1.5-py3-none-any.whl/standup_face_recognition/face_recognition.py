...
from standup_face_recognition.facenet_pytorch import InceptionResnetV1
...
class Siamese:
    def __init__(self):
        ...
        checkpoint = (
            torch.load("/home/timo/pip_installable/additional_material_face_recogniton/20180402-114759-vggface2.pt"))
        ...
        self.team_embedding = (
            torch.load("/home/timo/pip_installable/additional_material_face_recogniton/team_embedding.pth"))
