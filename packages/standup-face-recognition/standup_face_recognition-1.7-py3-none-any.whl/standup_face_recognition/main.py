...
from standup_face_recognition.face_recognition import Siamese
from standup_face_recognition.utils import imread_templates, resize_images_tensor, show_face, standup_roulette
    ...
    while True:
        ...
        if detected_faces_mtcnn[0][0] is not None:
            ...
            if counter % (smooth_filter - 1) == 0:
                ...
                face_det_reg = face_recognition.face_recognition(avg_faces, names)  # template_dict)
