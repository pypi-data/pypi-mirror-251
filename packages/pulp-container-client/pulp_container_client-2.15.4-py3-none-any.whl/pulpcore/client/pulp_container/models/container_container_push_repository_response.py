...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_created=None, description=None, pulp_labels=None, manifest_signing_service=None, pulp_href=None, versions_href=None, latest_version_href=None, retain_repo_versions=None, local_vars_configuration=None):  # noqa: E501
