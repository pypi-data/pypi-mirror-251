...
class Enums(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> EnumsWithRawResponse:
        return EnumsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> EnumsWithStreamingResponse:
        return EnumsWithStreamingResponse(self)
...
class AsyncEnums(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncEnumsWithRawResponse:
        return AsyncEnumsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncEnumsWithStreamingResponse:
        return AsyncEnumsWithStreamingResponse(self)
...
class EnumsWithStreamingResponse:
    def __init__(self, enums: Enums) -> None:
        self._enums = enums
...
class AsyncEnumsWithStreamingResponse:
    def __init__(self, enums: AsyncEnums) -> None:
        self._enums = enums
