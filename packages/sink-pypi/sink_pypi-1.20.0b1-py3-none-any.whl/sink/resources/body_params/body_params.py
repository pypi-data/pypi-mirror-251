...
class BodyParams(SyncAPIResource):
    ...
    @cached_property
    def with_raw_response(self) -> BodyParamsWithRawResponse:
        return BodyParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> BodyParamsWithStreamingResponse:
        return BodyParamsWithStreamingResponse(self)
...
class AsyncBodyParams(AsyncAPIResource):
    ...
    @cached_property
    def with_raw_response(self) -> AsyncBodyParamsWithRawResponse:
        return AsyncBodyParamsWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncBodyParamsWithStreamingResponse:
        return AsyncBodyParamsWithStreamingResponse(self)
...
class BodyParamsWithRawResponse:
    ...
    def unions(self) -> UnionsWithRawResponse:
        return UnionsWithRawResponse(self._body_params.unions)
...
class AsyncBodyParamsWithRawResponse:
    ...
    def unions(self) -> AsyncUnionsWithRawResponse:
        return AsyncUnionsWithRawResponse(self._body_params.unions)


class BodyParamsWithStreamingResponse:
    def __init__(self, body_params: BodyParams) -> None:
        self._body_params = body_params
    ...
    def unions(self) -> UnionsWithStreamingResponse:
        return UnionsWithStreamingResponse(self._body_params.unions)


class AsyncBodyParamsWithStreamingResponse:
    def __init__(self, body_params: AsyncBodyParams) -> None:
        self._body_params = body_params
    ...
    def unions(self) -> AsyncUnionsWithStreamingResponse:
        return AsyncUnionsWithStreamingResponse(self._body_params.unions)
