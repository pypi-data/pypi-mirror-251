...
class QtObject():
    ...
    def is_null(self) -> bool:
        ...
        if 'cache_uid' not in self.__dict__['_definition']:
            return False
        return self.__dict__['_definition']['cache_uid'] == '0'
    ...
    def list_properties(self) -> list:
        """
        Return the list of all available properties for this objet.
        """
        command = {}
        ...
        raise RuntimeError("Uknown error while listing properties")
    ...
    def __getattr__(self, name: str):
        ...
        raise AttributeError(f"Uknown error while getting attribute '{name}'")
