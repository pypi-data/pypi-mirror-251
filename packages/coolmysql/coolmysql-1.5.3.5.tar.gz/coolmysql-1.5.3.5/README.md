...
# 教程 ([查看美化版](https://lcctoor.github.io/arts/arts/mysql) 👈)
...
**注：下文中所有示例都同时支持同步方式和异步方式，将同步示例中的 insert、delete、update、select 替换为 ainsert、adelete、aupdate、aselect 即为异步方式，当然，须要加上 await 前缀。**
