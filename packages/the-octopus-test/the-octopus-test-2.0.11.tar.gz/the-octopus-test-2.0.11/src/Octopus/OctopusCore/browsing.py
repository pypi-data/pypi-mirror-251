...
from src.Octopus.OctopusCore.WebEventListener import WebEventListener
    ...
    def openBrowser(sBrowserType,sUrl):
       try:
           ...
           if str(sBrowserType).lower()=="chrome":
               # executable_path=os.getcwd()+Configuration.appSettings["ChromeDriverPath"]
               ...
               # executable_path=os.getcwd()+Configuration.appSettings["FirFoxDriverPath"]
               ...
               # executable_path=os.getcwd()+Configuration.appSettings["IEedgeDriverPath"]
