...
@deprecated(details="Please use OfflineClientV2 Instead")
class OfflineClient:
    """
    ...
    @deprecated(
        details="Please use OfflineClientV2: get_feature_range_values() Instead"
    )
    ...
    @deprecated(details="Please use OfflineClientV2: get_feature_values() Instead")
