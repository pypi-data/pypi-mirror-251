...
INSTANCE_TYPE_FILTER_CPU = 2
INSTANCE_TYPE_FILTER_GPU = 3
INSTANCE_TYPE_UNSPECIFIED = 0
INSTANCE_TYPE_CPU = 1
INSTANCE_TYPE_GPU = 2


_INSTANCETEMPLATESPEC = DESCRIPTOR.message_types_by_name['InstanceTemplateSpec']
_INSTANCEFILTER = DESCRIPTOR.message_types_by_name['InstanceFilter']
InstanceTemplateSpec = _reflection.GeneratedProtocolMessageType('InstanceTemplateSpec', (_message.Message,), {
  'DESCRIPTOR' : _INSTANCETEMPLATESPEC,
  '__module__' : 'qwak.instance_template.instance_template_pb2'
  # @@protoc_insertion_point(class_scope:qwak.management.instance_template.InstanceTemplateSpec)
  })
_sym_db.RegisterMessage(InstanceTemplateSpec)

InstanceFilter = _reflection.GeneratedProtocolMessageType('InstanceFilter', (_message.Message,), {
  'DESCRIPTOR' : _INSTANCEFILTER,
  '__module__' : 'qwak.instance_template.instance_template_pb2'
  # @@protoc_insertion_point(class_scope:qwak.management.instance_template.InstanceFilter)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _INSTANCETYPEFILTER._serialized_start=486
  _INSTANCETYPEFILTER._serialized_end=634
  _INSTANCETYPE._serialized_start=636
  _INSTANCETYPE._serialized_end=727
  _INSTANCETEMPLATESPEC._serialized_start=135
  _INSTANCETEMPLATESPEC._serialized_end=380
  _INSTANCEFILTER._serialized_start=382
  _INSTANCEFILTER._serialized_end=483
