...
#define MI_EXTERN_STRUCT(Name)                                                  \
    ...
    MI_EXTERN_LIB template struct MI_EXPORT_LIB Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_EXTERN_CLASS(Name)                                                   \
    ...
    MI_EXTERN_LIB template class MI_EXPORT_LIB Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_INSTANTIATE_STRUCT(Name)                                             \
    ...
    template struct MI_EXPORT Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_INSTANTIATE_CLASS(Name)                                              \
    ...
    template class MI_EXPORT Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_INVOKE_VARIANT(variant, func, ...)                                   \
    [&]() {                                                                     \
        ...
        else if (variant == "llvm_rgb")                                         \
            return func<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>(__VA_ARGS__); \
        else                                                                    \
            Throw("Unsupported variant: \"%s\". Must be one of scalar_mono, scalar_mono_double, scalar_rgb, scalar_spectral, llvm_rgb!", variant); \
    }()                                                                         \
...
template <typename Float_, typename Spectrum_> constexpr const char *get_variant() {
    ...
    else if constexpr (std::is_same_v<Float_, dr::LLVMArray<float>> &&
                       std::is_same_v<Spectrum_, Color<dr::LLVMArray<float>, 3>>)
        return "llvm_rgb";
    else
        return "";
}
