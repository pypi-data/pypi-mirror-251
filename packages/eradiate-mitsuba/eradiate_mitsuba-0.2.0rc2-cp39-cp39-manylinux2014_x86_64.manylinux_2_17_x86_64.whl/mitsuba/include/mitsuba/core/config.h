...
#define MI_EXTERN_STRUCT(Name)                                                  \
    ...
    MI_EXTERN_LIB template struct Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_EXTERN_CLASS(Name)                                                   \
    ...
    MI_EXTERN_LIB template class Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_INSTANTIATE_STRUCT(Name)                                             \
    ...
    template struct Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>; \
...
#define MI_INSTANTIATE_CLASS(Name)                                              \
    ...
    template class Name<dr::LLVMArray<float>, Color<dr::LLVMArray<float>, 3>>;  \
