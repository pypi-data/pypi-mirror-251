...
class DataSourceClient:
    ...
    def upsert_data_source_from_files(self, *, files: typing.List[str]) -> typing.List[DataSource]:
        """
        Upserts a data source.
        Updates if a data source with the same name and user_id already exists.Otherwise, creates a new data source.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "PUT",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/data_source/file_upload"),
    ...
    def get_data_source_file_content(self, data_source_id: str, loaded_file_id: str) -> LoadedFilePayload:
        ...
        client.data_source.get_data_source_file_content(
            data_source_id="string",
...
class AsyncDataSourceClient:
    ...
    async def upsert_data_source_from_files(self, *, files: typing.List[str]) -> typing.List[DataSource]:
        """
        Upserts a data source.
        Updates if a data source with the same name and user_id already exists.Otherwise, creates a new data source.
    ...
    async def get_data_source_file_content(self, data_source_id: str, loaded_file_id: str) -> LoadedFilePayload:
        ...
        await client.data_source.get_data_source_file_content(
            data_source_id="string",
            loaded_file_id="string",
        )
        """
