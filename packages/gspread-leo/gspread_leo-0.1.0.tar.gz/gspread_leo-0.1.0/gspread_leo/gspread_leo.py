...
credencial = r'C:\Users\leani\AppData\Roaming\gspread\cliente.json'
...
def Criar_pagina2(nome, key = '1YAdc2ZefohO6o0532Tc34-huUIr5hUUS4WRXVmYDRZ8'):
    return gc.open_by_key(key).add_worksheet(title=nome, rows=100, cols=20)

def Ler_celulas2(intervalo = "A1:B2", key = '1YAdc2ZefohO6o0532Tc34-huUIr5hUUS4WRXVmYDRZ8', pagina = "campos do jordão"):
    return gc.open_by_key(key).worksheet(pagina).get(intervalo)

def Atualizar_celulas2(valor:list[list],intervalo = "g1:h2", key = '1YAdc2ZefohO6o0532Tc34-huUIr5hUUS4WRXVmYDRZ8', pagina = "campos do jordão" ):
    gc.open_by_key(key).worksheet(pagina).update(intervalo, valor)
