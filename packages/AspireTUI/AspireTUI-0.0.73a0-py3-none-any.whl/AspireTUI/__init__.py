...
_log.settings.Title = f"Created with: AspireTUI (TODO VER), {_now}"
# For debugging purposes this extreme
_log.settings.LogLevel_ShowUser = 0
_log.settings.LogLevel_SaveLog = 0
_log.DEBUG(f"Logging Enabled: {_os.path.abspath(_os.path.curdir)} // {_log.settings.filename}")
_log.INFO(f"Yay! Another log entry! -- %r -- %S", "Just here", "for testing!")
