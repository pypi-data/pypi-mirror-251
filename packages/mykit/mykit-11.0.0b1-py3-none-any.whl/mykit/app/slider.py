...
class _Slider:
    ...
    slider_tags: _Dict[str, _List['_Slider']] = {}  
    def __init__(
        self,
        min: float = 0,
        max: float = 1,
        ...
        rod_thick: int = 3,
        btn_r: int = 5,
        color_rod_normal: str = '
        color_rod_locked: str = '
        color_btn_normal: str = '
        color_btn_locked: str = '
        color_btn_press: str = '
        color_btn_hover: str = '
        color_btn_bd_normal: str = '
        color_btn_bd_locked: str = '
        locked: bool = False,
        visible: bool = True,
