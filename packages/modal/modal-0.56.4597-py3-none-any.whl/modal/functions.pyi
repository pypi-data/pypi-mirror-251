...
def _validate_volumes(volumes: typing.Dict[typing.Union[str, os.PathLike], modal.volume._Volume]) -> typing.List[typing.Tuple[str, typing.Union[modal.volume._Volume, modal.network_file_system._NetworkFileSystem]]]:
    ...
