...
class FinancialBase(SearchModel):
    description: str
    ...
    def __str__(self):
        return f'{self.created} R$ {self.amount} ({self.description})'
...
if __name__ == '__main__':
    e = Entry(transaction='CAT 600 C 2024-01-01 invoice Daniel Victor Arantes')
    print(e)