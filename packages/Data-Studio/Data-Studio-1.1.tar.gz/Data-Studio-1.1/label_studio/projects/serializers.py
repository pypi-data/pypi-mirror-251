...
class ProjectSerializer(FlexFieldsModelSerializer):
    ...
    contributors = serializers.SerializerMethodField(default=None, help_text='Project contributors')
    ...
    def get_contributors(self, obj):
        # Fetch contributors specific to the project 'obj'
        project_roles = ProjectRole.objects.filter(project=obj)
        return ContributorSerializer(project_roles, many=True).data
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'label_config', 'expert_instruction', 'show_instruction', 'show_skip_button',
                  ...
                  'finished_task_number','is_public','contributors']
