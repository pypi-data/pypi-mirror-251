...
@dataclasses.dataclass
class TestCaseCreateSegments:
    pass


@dataclasses.dataclass
class TestCaseCreateInfo:
    pass
...
class TestCaseCreate:
    ...
    input: TestCaseCreateInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('input') }})
    ...
    info: Optional[TestCaseCreateInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('info') }})
    ...
    segments: Optional[TestCaseCreateSegments] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('segments') }})
