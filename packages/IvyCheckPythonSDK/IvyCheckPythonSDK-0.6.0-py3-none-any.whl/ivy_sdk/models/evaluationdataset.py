...
@dataclasses.dataclass
class EvaluationDatasetTestConfig:
    pass
...
class EvaluationDataset:
    ...
    test_config: Optional[EvaluationDatasetTestConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('test_config') }})
