...
# %% auto 0
__all__ = ['U1', 'Property', 'slotprops', 'props']
...
U1, __DOC__, __NAME__, __PROPS__ = '_', '__doc__', '__name__', '__props__'
...
class Property(NamedTuple):
    ...
    gen : Optional[Callable[[Self], Any]], optional
    ...
    def make(self: Self) -> property:
        ...
        def prop(self: Self) -> ann:
            ...
            if not hasp or pval is bad:
                try: setattr(self, prv, gen(self))
                except: setattr(self, prv, val)
...
def slotprops(props: dict[str, Property] = dict()):
    ...
    '''
    @classmethod
    def getprops(cls: type, *args, **kwargs) -> dict:
