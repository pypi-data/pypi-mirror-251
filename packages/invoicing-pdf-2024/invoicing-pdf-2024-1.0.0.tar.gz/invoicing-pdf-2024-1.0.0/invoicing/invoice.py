...
def generate(invoices_path, pdfs_path, image_path, product_id, product_name, amount_purchased, price_per_unit,
    ...
    :param invoices_path: Path to the invoices folder.
    :param pdfs_path: Folder name where will be stored the PDFs.
    ...
    :param price_per_unit: Amount per unit column name.
    :param total_price: Amount total column name.
    """
