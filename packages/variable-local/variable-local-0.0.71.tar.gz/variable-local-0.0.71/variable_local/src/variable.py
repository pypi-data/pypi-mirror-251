...
class VariablesLocal(GenericCRUD):
    ...
    def set_variable_value_by_variable_id(self, variable_id: int, variable_value: str,profile_id: str,state_id: int) -> None:
        logger.start(object={'variable_id': variable_id,
        ...
        data_json = {'variable_id': variable_id, 'variable_value_new': variable_value,'profile_id':profile_id,'state_id':state_id}
