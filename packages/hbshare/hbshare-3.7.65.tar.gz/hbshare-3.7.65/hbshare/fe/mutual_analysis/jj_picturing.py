...
def mutual_pool_picture(pool_name,asofdate1,asofdate2,latest_date,fool_version=False,bmk_id='930950'):
    ...
    sql = "select max(jsrq) as jsrq from st_fund.t_st_gm_jjhyzhyszb where hyhfbz='2' and zclb='1' "
...
if __name__ == '__main__':
    ...
    # prv_pool_picture(latest_date='20231229',style_date='20231231',latest_HB1001_spjg=2082.88139348)
    # mutual_pool_picture('君瑞','20230630', '20230831', '20231229',fool_version=True,bmk_id='885001')
    # # mutual_pool_picture('FOF1号','20230630', '20230831', '20231229',fool_version=True,bmk_id='885001')
    mutual_pool_picture('公募核心池','20230630', '20230831', '20240111',fool_version=True)
    # mutual_pool_picture('牛基宝','20230630', '20230831', '20240105',fool_version=True)
    # mutual_pool_picture('公募30池偏股基金', '20230630', '20230831', '20240111',fool_version=True)
    # mutual_pool_picture('公募机构池', '20230630', '20230831', '20240111',fool_version=True)
