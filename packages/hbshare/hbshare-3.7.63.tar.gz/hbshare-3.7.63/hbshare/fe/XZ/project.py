...
if __name__ == '__main__':
    ...
    st=stratage_timing()
    st.market_liquidity('20070101','20240105')
    st.market_style_distinguish('20070101','20240105')
    st.market_states_distinguish('20070101','20240105')
    st.marco_eco_states_distinguish('2007-01-01','2024-01-05')
    st.currency_states_distinguish('2007-12-01', '2024-01-05')
    st.industry_states_distinguish('20070101','20240105')
    st.stratage_cycle_distinguish('20240105')
