...
class SDKClient:
    ...
    def __init__(self, **kwargs: str) -> None:
        ...
        if 'username' in kwargs and 'password' in kwargs:
            ...
            raise EnvironmentError(f'Neigher username/password, nor environment variables {_ACCESS_TOKEN_ENV_KEY}/{_REFRESH_TOKEN_ENV_KEY} were found - falling back on authentication code flow did not work as you are in no browser environment!')
