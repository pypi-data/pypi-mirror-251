...
Copyright (C) 2017-2023, Michele Cappellari
...
class capfit:
    ...
    and number of functions evaluations, than the best unconstrained or
    ...
    If you use this software for your research, please cite the paper by 
    `Cappellari (2023) <https://ui.adsabs.harvard.edu/abs/2023MNRAS.526.3273C>`_, 
    where this method was described in Section 3.2. 
