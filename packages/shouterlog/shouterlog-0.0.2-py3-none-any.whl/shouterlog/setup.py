...
setup(
    name="shouterlog",
    packages=["shouterlog"],
    install_requires=['### shouterlog.py', 'attrs>=22.2.0', 'dill==0.3.7'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A custom logging tool that expands normal logger with additional formatting and debug capabilities.", keywords="['python', 'logging', 'debug tool']", version="0.0.2"
)
