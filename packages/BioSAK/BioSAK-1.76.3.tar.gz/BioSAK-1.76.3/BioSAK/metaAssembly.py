...
def metaAssembly(args):
    ...
    cmd_index = 1
    for each_cmd in cmd_set:
        print('Processing %s/%s' % (cmd_index, len(cmd_set)))
        os.system(each_cmd)
        cmd_index += 1
        ...
        if os.path.isfile(op_metadata_tsv) is False:
            ...
            for each_line in open(op_metadata_tsv):
                ...
                if line_num_index == 1:
                    ...
                    if line_split[col_index['Assembly BioSample Attribute Name']] != '':
                        biosample_attribute_name      = line_split[col_index['Assembly BioSample Attribute Name']]
                    if line_split[col_index['Assembly BioSample Attribute Value']] != '':
...
if __name__ == '__main__':
    ...
    #metaAssembly_parser.add_argument('-t', required=False, type=int, default=1,   help='number of core, default: 1')
