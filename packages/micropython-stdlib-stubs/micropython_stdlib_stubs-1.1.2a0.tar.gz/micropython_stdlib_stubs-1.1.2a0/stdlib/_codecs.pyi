...
if sys.version_info >= (3, 9):
    def raw_unicode_escape_decode(__data: str | ReadableBuffer, __errors: str | None = None, __final: bool = True) -> tuple[str, int]: ...
...
if sys.version_info >= (3, 9):
    def unicode_escape_decode(__data: str | ReadableBuffer, __errors: str | None = None, __final: bool = True) -> tuple[str, int]: ...
