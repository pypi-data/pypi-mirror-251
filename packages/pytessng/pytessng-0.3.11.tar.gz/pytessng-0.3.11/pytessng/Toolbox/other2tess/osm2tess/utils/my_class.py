...
class NetworkCreator:
    ...
    路网会根据投影信息自动移动到场景中心。
    """
    def __init__(self, netiface, network: Network, move_to_center:bool=True):
        ...
        # 移到中心的x坐标
        self.network_move_x = self.network_other["move_distance"]["x_move"]
        # 移到中心的y坐标
        self.network_move_y = self.network_other["move_distance"]["y_move"]
        # 路段映射
