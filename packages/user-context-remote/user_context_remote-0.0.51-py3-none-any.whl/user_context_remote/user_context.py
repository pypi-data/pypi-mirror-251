...
class UserContext:
    ...
    def _authenticate_by_user_identification_and_password(self, user_identifier: str, password: str) -> str:
        ...
        try:
            ...
            authentication_login_response_json = requests.post(
                url=authentication_login_enpoint_url, data=json.dumps(authentication_login_request_json, separators=(",", ":")), headers=headers
            )
    ...
    def _authenticate_by_user_jwt(self, user_jwt: str) -> str:
        ...
        validate_user_jwt_response_json = requests.post(
            url=authentication_login_validate_user_jwt_url, data=json.dumps(validate_user_jwt_request_json, separators=(",", ":")), headers=headers
        )
    ...
    def _get_user_data_login_response(self, validate_user_jwt_response: str) -> None:
