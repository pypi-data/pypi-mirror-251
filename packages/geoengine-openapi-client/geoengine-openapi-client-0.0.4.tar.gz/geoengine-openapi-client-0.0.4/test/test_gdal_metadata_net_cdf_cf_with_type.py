...
from geoengine_openapi_client.models.gdal_metadata_net_cdf_cf_with_type import GdalMetadataNetCdfCfWithType  # noqa: E501

class TestGdalMetadataNetCdfCfWithType(unittest.TestCase):
    """GdalMetadataNetCdfCfWithType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdalMetadataNetCdfCfWithType:
        """Test GdalMetadataNetCdfCfWithType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdalMetadataNetCdfCfWithType`
        """
        model = GdalMetadataNetCdfCfWithType()  # noqa: E501
        if include_optional:
            return GdalMetadataNetCdfCfWithType(
                band_offset = 0,
                cache_ttl = 0,
                end = 56,
    ...
    def testGdalMetadataNetCdfCfWithType(self):
        """Test GdalMetadataNetCdfCfWithType"""
