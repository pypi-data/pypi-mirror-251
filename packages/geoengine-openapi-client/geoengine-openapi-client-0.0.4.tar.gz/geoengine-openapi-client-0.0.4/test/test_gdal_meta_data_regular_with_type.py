...
from geoengine_openapi_client.models.gdal_meta_data_regular_with_type import GdalMetaDataRegularWithType  # noqa: E501

class TestGdalMetaDataRegularWithType(unittest.TestCase):
    """GdalMetaDataRegularWithType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GdalMetaDataRegularWithType:
        """Test GdalMetaDataRegularWithType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GdalMetaDataRegularWithType`
        """
        model = GdalMetaDataRegularWithType()  # noqa: E501
        if include_optional:
            return GdalMetaDataRegularWithType(
                cache_ttl = 0,
    ...
    def testGdalMetaDataRegularWithType(self):
        """Test GdalMetaDataRegularWithType"""
