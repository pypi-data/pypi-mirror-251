...
def copy_animation(frame_height, fps, bg_path):
    ...
    if video.duration > 60:
        part_1 = f'ffmpeg -i {source_file} -ss 00:00:00 -t 00:00:60 -async 1 -c copy ./downloads/EquationAnimation_first_half.mp4'
        subprocess.call(part_1, shell=True)
        part_2 = f'ffmpeg -i {source_file} -ss 00:00:60 -async 1 -c copy ./downloads/EquationAnimation_second_half.mp4'
