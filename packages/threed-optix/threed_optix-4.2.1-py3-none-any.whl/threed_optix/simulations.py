...
class Setup(object):
    ...
    def _get_parts(self):
        print_thread = threading.Thread(target=au._getting_parts)
        retrieve_thread = threading.Thread(target=self._retrieve_parts)
        retrieve_thread.start()
        print_thread.start()
        print_thread.join()
        retrieve_thread.join()
        if hasattr(self, 'retrieving_parts_error'):
            raise self.retrieving_parts_error
