...
atoks = pipe.s2a.generate(stoks, pipe.default_speaker.unsqueeze(0).to(torch.float16), top_k=64, T=.7)
print()

# %% ../nbs/Model inference tests-Copy1.ipynb 12
def generate_test():
    text = """
    Welcome to Burger Shack. What can I get for you today?
    """
    ...
    with record_function("s2a"):
        atoks = pipe.s2a.generate(stoks, pipe.default_speaker.unsqueeze(0), top_k=64, T=.7, show_progress_bar=False)
