...
class AssignmentApi:
    ...
    def get_assignment(
        ...
        identifier: Annotated[StrictStr, Field(description="The identifier of the Assignment. If this is an External Id, prepend the value with the pike character `|` (e.g. `|ABC123`)")],
