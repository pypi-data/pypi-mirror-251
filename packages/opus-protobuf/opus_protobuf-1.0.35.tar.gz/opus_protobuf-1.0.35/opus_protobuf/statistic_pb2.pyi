...
class InstagramControllerResponse(_message.Message):
    ...
    have_mean: bool
    def __init__(self, data: _Optional[_Union[InstagramApiResponse, _Mapping]] = ..., have_mean: bool = ...) -> None: ...
...
class GetInstagramLikesRequest(_message.Message):
    ...
    data: _containers.RepeatedCompositeFieldContainer[AccessInstagram]
    broke: bool
    def __init__(self, data: _Optional[_Iterable[_Union[AccessInstagram, _Mapping]]] = ..., broke: bool = ...) -> None: ...

class CalculateMeanRequest(_message.Message):
    __slots__ = ("mean", "new_sample", "n")
    MEAN_FIELD_NUMBER: _ClassVar[int]
    NEW_SAMPLE_FIELD_NUMBER: _ClassVar[int]
    N_FIELD_NUMBER: _ClassVar[int]
    mean: int
    new_sample: int
    n: int
    def __init__(self, mean: _Optional[int] = ..., new_sample: _Optional[int] = ..., n: _Optional[int] = ...) -> None: ...
