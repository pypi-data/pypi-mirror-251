...
class YoutubeBasicInfoExtractor:
    ...
    def extract_video_renderer(renderer):
        ...
        browse_endpoint = YoutubeBasicInfoExtractor._extract_browse_endpoint(browse_endpoint_raw)
    ...
    def extract_continuation_item_renderer(renderer):
        ...
        continuation_comamnd = YoutubeBasicInfoExtractor._extract_continuation_command(continuation_command_raw)
    ...
    @staticmethod
    def _extract_toggle_button_renderer(renderer):
    ...
    def extract_comment_renderer(renderer):
        ...
        like_button_info = YoutubeBasicInfoExtractor._extract_toggle_button_renderer(like_button['toggleButtonRenderer'])
