...
BEHINDER_DEFAULTpas = "rebeyond"

GODZILLA_DEFAULT_PASS = "pass"
GODZILLA_DEFAULT_KEY = "key"


def get_behinder4_jsp_shell(pas=BEHINDER_DEFAULTpas):
...
def get_behinder4_php_shell(pas=BEHINDER_DEFAULTpas):
...
def get_behinder4_aspx_shell(pas=BEHINDER_DEFAULTpas):
