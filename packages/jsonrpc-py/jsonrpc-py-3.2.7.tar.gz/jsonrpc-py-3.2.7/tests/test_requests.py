...
class TestBatchRequest(TestCase):
    ...
    def test_hash(self) -> None:
        ...
        self.assertEqual(hash(batch_request), hash((BatchRequest, tuple(requests))))
