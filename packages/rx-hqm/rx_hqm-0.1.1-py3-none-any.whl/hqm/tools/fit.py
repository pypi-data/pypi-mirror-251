...
class fit:
    ...
    def _fit_setup(self):
        ...
        self.fitobj = zfitter(self.total_model, self.data)

    def _fit_data(self, ntries, pval_threshold, fit_range):
        self.result = self.fitobj.fit(
            ntries=ntries, pval_threshold=pval_threshold, d_const=self._gauss_constraint, ranges=fit_range
        )
    ...
    def fit_data(self, ntries=10, pval_threshold=0.05, fit_range=None):
        self._fit_setup()
        self._fit_data(ntries, pval_threshold, fit_range)
