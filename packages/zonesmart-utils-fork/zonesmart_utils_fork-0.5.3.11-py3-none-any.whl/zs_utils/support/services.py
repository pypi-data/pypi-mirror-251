...
class CommonSupportTicketService:
    """
    Сервис для работы с тикетами (BaseSupportTicket)
    """
    @classmethod
    ...
    def create_ticket_message(
        cls,
        ticket: models.BaseSupportTicket,
        sender,
        is_system: bool,
        text: str = None,
        files: list[models.BaseSupportTicketMessageFile] = None,
        **kwargs,
    ) -> models.BaseSupportTicketMessage:
