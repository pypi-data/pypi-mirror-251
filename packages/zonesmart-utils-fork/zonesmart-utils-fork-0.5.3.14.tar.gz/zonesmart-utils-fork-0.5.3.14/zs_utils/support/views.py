...
class BaseSupportTicketView(CustomModelViewSet):
    ...
    def limit_queryset(self, queryset):
        ...
        if hasattr(user, "is_admin") and user.is_admin or hasattr(user, "is_superuser") and user.is_superuser:
            return queryset
    ...
    def create(self, request, *args, **kwargs):
        ...
        return self.build_response(data=self.get_serializer_class()(instance).data)
...
class BaseSupportTicketMessageView(CustomModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if signature:
            if data.get("text") and (data["sender"] != self.get_user()):
                data["text"] += signature
