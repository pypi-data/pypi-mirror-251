...
class MLModel:
    ...
    def create_new_ml_model(self, props: RegisterModelProps):
        ...
        ml_model_versions_id = inserted_ml_model["data"]["create"+ml_model_api]["mlModelApiEdge"]["node"]["mlModelVersionsApis"]["nodes"][0]["ml_model_versions_id"]
        ml_model_id = inserted_ml_model["data"]["create"+ml_model_api]["mlModelApiEdge"]["node"]["mlModelVersionsApis"]["nodes"][0]["ml_model_id"]
    ...
    def update_ml_model(self, ml_model_id, props: RegisterModelProps):
        ...
        """
        inserted_ml_model = self._graphql_web_client.query(query, "mutation")
        ml_model_versions_id = inserted_ml_model["data"]["update"+ml_model_api]["mlModelApiEdge"]["node"]["mlModelVersionsApis"]["nodes"][0]["ml_model_versions_id"]
        self.update_version(ml_model_id, ml_model_versions_id)
