...
class CassandraOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        ...
        parser.add_argument(
            '--cassandra_table_index',
            default='traitdata',
            help='table name for index data table'
        )
        parser.add_argument(
...
class CassandraWindowOptions(PipelineOptions):

    @classmethod
    def _add_argparse_args(cls, parser):
        parser.add_argument(
            '--process_data_window_duration',
            default=10,
            help='cassandra processData scan window duration seconds'
        )
        parser.add_argument(
            '--index_data_window_duration',
            default=10,
            help='cassandra indexData scan window duration seconds'
        )
        parser.add_argument(
            '--index_data_slide_duration',
            default=10,
            help='cassandra indexData scan window slide duration seconds'
        )
