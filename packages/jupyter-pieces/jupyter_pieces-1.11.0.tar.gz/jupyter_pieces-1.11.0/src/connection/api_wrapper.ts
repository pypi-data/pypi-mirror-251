...
const fetchSnapshot = async ({
  ...
  try {
    ...
    if (!retry) {
      ...
      notifications.error({
        message:
          'Failed to load snippets. Please restart Pieces OS, ensure that it is up-to-date, and try again. If the problem persists please reach out to support at support@pieces.app.',
      });
