    ...
    return config.annotationApi
      ...
      .catch(() => {
        Notifications.getInstance().error({
          message:
            'Something went wrong updating that annotation! If the issue persists, please contact support@pieces.app. Make sure that Pieces OS is installed, up to date, and running!',
        });
        return annotation;
      });
  }
    ...
    if (!isNew) {
      config.annotationsApi
        ...
        .catch((e) => {
          Notifications.getInstance().error({
            message:
              'Error deleting that annotation! If the issue persists, please contact support@pieces.app. Make sure that Pieces OS is installed, up to date, and running.',
          });
        });
    }
  };
    ...
    if (isNew) {
      ...
      return config.annotationsApi
        ...
        .catch(() => {
          Notifications.getInstance().error({
            message:
              'Something went wrong creating that annotation! If the issue persists, please contact support@pieces.app. Make sure that Pieces OS is installed, up to date, and running!',
          });
          return annotation;
        });
    } else {
