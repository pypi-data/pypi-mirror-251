    ...
    def calc_priority_cve(self, cve_id):
        ...
        if cisa_kev_result:
            ...
            if epss_result.get("epss") >= self.epss_score:
                self.__model_append(2, cve_id, 'Priority 1', epss_result.get('epss'),
                                nist_result.get('cvss_baseScore'), nist_result.get('cvss_version'),
                                nist_result.get('cvss_severity'), 'FALSE', nist_result.get('status'))
            else:
                self.__model_append(3, cve_id, 'Priority 2', epss_result.get('epss'),
                                nist_result.get('cvss_baseScore'), nist_result.get('cvss_version'),
                                nist_result.get('cvss_severity'), 'FALSE', nist_result.get('status'))
        else:
            if epss_result.get("epss") >= self.epss_score:
                self.__model_append(4, cve_id, 'Priority 3', epss_result.get('epss'),
                                nist_result.get('cvss_baseScore'), nist_result.get('cvss_version'),
                                nist_result.get('cvss_severity'), 'FALSE', nist_result.get('status'))
            else:
                self.__model_append(5, cve_id, 'Priority 4', epss_result.get('epss'),
                                nist_result.get('cvss_baseScore'), nist_result.get('cvss_version'),
                                nist_result.get('cvss_severity'), 'FALSE', nist_result.get('status'))
