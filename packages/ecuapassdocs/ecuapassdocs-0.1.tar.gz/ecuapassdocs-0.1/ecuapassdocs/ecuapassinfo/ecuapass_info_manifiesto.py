...
class EcuMNF (EcuInfo):
	...
	def getMainFields (self):
		...
		try:
			...
			self.ecudoc ["18_Ano_Fabricacion"]   = vehiculo ["anoFabricacion"]
			...
			self.ecudoc ["25_Ano_Fabricacion"]   = remolque ["anoFabricacion"]
	...
	def getVehiculoRemolqueInfo (self, vehicleType):
		keysVehiculo = {"marca": "04_Camion_Marca", "fabricacion": "05_Camion_AnoFabricacion", "placaPais": "06_Camion_PlacaPais", 
		                 "chasis": "07_Camion_Chasis", "certificado": "08_Certificado_Habilitacion"}
		keyRemolque = {"marca": "09_Remolque_Marca", "fabricacion": "10_Remolque_AnoFabricacion", "placaPais": "11_Remolque_PlacaPais", 
		                 "chasis": "12_Remolque_Otro", "certificado": "08_Certificado_Habilitacion"}

		vehiculo      = {"marca": None, "anoFabricacion": None, "pais": None, "placa": None,
		...
		try:
			...
			vehiculo ["anoFabricacion"] = Utils.getValue (self.fields, keys ["fabricacion"])
