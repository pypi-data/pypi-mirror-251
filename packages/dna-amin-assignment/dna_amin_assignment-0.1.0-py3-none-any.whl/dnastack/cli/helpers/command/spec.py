...
from dnastack.cli.helpers.printers.iterator_printer import OutputFormat
...
DATA_OUTPUT_SPEC = ArgumentSpec(
    ...
    arg_names=['--output', '-o'],
    as_option=True,
    choices=[OutputFormat.CSV, OutputFormat.JSON, OutputFormat.YAML, OutputFormat.TABLE],
    help='Output format',
