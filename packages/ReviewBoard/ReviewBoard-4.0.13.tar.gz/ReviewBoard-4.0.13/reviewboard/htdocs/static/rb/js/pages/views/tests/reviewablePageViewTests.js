  ...
  describe('Actions', function () {
    ...
    describe('Ship It', function () {
      ...
      it('Confirmed', function () {
        ...
        spyOn(pendingReview, 'ready').and.callFake((options, context) => options.ready.call(context));
        spyOn(pendingReview, 'save').and.callFake((options, context) => options.success.call(context));
