    ...
    describe('Expanding', function () {
      ...
      describe('Injecting HTML', function () {
        it('Whole chunk', function (done) {
          spyOn(model, 'getRenderedDiffFragment').and.resolveTo(['<tbody class="equal tests-new-chunk">', ' <tr line="6">', '  <th></th>', '  <td>', '   <div class="collapse-floater">', '    <div class="rb-c-diff-collapse-button"', '         data-chunk-index="1"', '         data-lines-of-context="0"></div>', '   </div>', '  </td>', '  <th></th>', '  <td></td>', ' </tr>', '</tbody>'].join(''));
