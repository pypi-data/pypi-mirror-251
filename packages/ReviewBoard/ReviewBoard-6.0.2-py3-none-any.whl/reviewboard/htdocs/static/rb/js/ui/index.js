(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@beanbag/spina'), require('codemirror')) :
    typeof define === 'function' && define.amd ? define(['exports', '@beanbag/spina', 'codemirror'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.RB = global.RB || {}, global.Spina, global.CodeMirror));
})(this, (function (exports, spina, CodeMirror) { 'use strict';

    var _class$9, _class2$2, _dec$1, _class3$2;
     ...
     */
    let DnDDropTarget = spina.spina(_class$9 = class DnDDropTarget extends spina.BaseModel {
      defaults() {
        return {
          $target: $(window),
          callback: function () {},
    ...
    var _class$8, _class2$1, _class3$1, _class4$1;
     ...
     */
    let CodeMirrorWrapper = spina.spina(_class$8 = class CodeMirrorWrapper extends spina.BaseView {
    ...
    let FormattingToolbarView = spina.spina(_class3$1 = class FormattingToolbarView extends spina.BaseView {
      ...
      initialize(options) {
       ...
       aria-role="button" tabindex="0">`).append($('<input type="file" style="display: none;">').on('change', this.#onImageUpload.bind(this))),
    ...
    var _dec, _class$7, _dec2, _class2, _dec3, _class3, _class4;
    /**
    ...
    let InlineEditorView = (_dec = spina.spina({
    ...
    }), _dec(_class$7 = class InlineEditorView extends spina.BaseView {
      /**
      ...
      onInitialRender() {
        ...
        if (options.showButtons) {
          this.$buttons = $('<div>').hide().addClass('rb-c-inline-editor__actions').appendTo($form);
          $('<button class="rb-c-button" data-action="save">').append($('<span class="rb-c-button__icon">').attr('aria-hidden', 'true')).append($('<label class="rb-c-button__label">').text(gettext("Save"))).attr('aria-label', fieldLabel ? interpolate(gettext("Save %(fieldLabel)s"), {
            "fieldLabel": fieldLabel
          }, true) : gettext("Save the field")).appendTo(this.$buttons).click(e => {
            e.preventDefault();
            e.stopPropagation();
            this.submit();
          });
          $('<button class="rb-c-button" data-action="cancel">').append($('<span class="rb-c-button__icon">').attr('aria-hidden', 'true')).append($('<label class="rb-c-button__label">').text(gettext("Cancel"))).attr('aria-label', fieldLabel ? interpolate(gettext("Cancel editing %(fieldLabel)s and discard changes"), {
            "fieldLabel": fieldLabel
          }, true) : gettext("Cancel editing and discard changes")).appendTo(this.$buttons).click(e => {
            e.preventDefault();
            e.stopPropagation();
            this.cancel();
          });
        ...
        if (options.showEditIcon) {
          ...
          if (options.editIconPath) {
            ...
            this._$editIcon.append(`<div class="${options.editIconClass}" aria-hidden="true"></div>`);
          }
     ...
     */
    let RichTextInlineEditorView = (_dec2 = spina.spina({
      prototypeAttrs: ['defaultOptions']
    }), _dec2(_class2 = class RichTextInlineEditorView extends InlineEditorView {
      /**
       * Defaults for the view options.
       */
     ...
     *     5.0
     */
    let DateInlineEditorView = (_dec3 = spina.spina({
      prototypeAttrs: ['defaultOptions']
    }), _dec3(_class3 = class DateInlineEditorView extends InlineEditorView {
      /**
       * Defaults for the view options.
       */
      static defaultOptions = _.defaults({
     ...
     *     6.0
     */
    exports.FieldStateLabelThemes = void 0;
     ...
     *     6.0
     */
    (function (FieldStateLabelThemes) {
      FieldStateLabelThemes["DRAFT"] = "draft";
      FieldStateLabelThemes["DELETED"] = "deleted";
    })(exports.FieldStateLabelThemes || (exports.FieldStateLabelThemes = {}));
    /**
    ...
    let FieldStateLabelView = spina.spina(_class$6 = class FieldStateLabelView extends spina.BaseView {
      ...
      initialize(options) {
        ...
        this.#theme = options.theme || exports.FieldStateLabelThemes.DRAFT;
      }
    ...
    let MenuView = spina.spina(_class$4 = class MenuView extends spina.BaseView {
       ...
       */
      static TYPE_STANDARD_MENU = exports.MenuType.Standard;
      static TYPE_BUTTON_MENU = exports.MenuType.Button;
      ...
      initialize() {
        let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        super.initialize(options);
        if (options.type === undefined || options.type === exports.MenuType.Standard) {
          this.type = exports.MenuType.Standard;
        } else if (options.type === exports.MenuType.Button) {
          this.type = exports.MenuType.Button;
        } else {
      ...
      onInitialRender() {
        ...
        if (this.type === exports.MenuType.Button) {
      ...
      addItem() {
        ...
        } else if (this.type === exports.MenuType.Standard) {
...
<% } %>`);
      ...
      initialize(options) {
        ...
        this.#menuType = options.menuType || exports.MenuType.Standard;
