    ...
    describe('setDraftField', function () {
      ...
      describe('When publishing', function () {
        ...
        it('Successful saves', function () {
          spyOn(draft, 'save').and.callFake((options, context) => options.success.call(context));
        ...
        it('Field set errors', function () {
          spyOn(draft, 'save').and.callFake((options, context) => options.error.call(context, draft, {
            errorPayload: {
              fields: {
  ...
  describe('Reviewed objects', function () {
    describe('File attachments', function () {
      it('Removed when destroyed', function (done) {
        ...
        spyOn(draft, 'ensureCreated').and.callFake((options, context) => options.success.call(context));
        expect(fileAttachments.at(0)).toBe(fileAttachment);
