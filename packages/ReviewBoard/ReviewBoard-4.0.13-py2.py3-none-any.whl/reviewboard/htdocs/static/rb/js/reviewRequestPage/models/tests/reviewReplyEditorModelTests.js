...
suite('rb/reviewRequestPage/models/ReviewReplyEditor', function () {
  ...
  beforeEach(function () {
    ...
    spyOn(review, 'ready').and.callFake((options, context) => options.ready.call(context));
    spyOn(reviewReply, 'ensureCreated').and.callFake((options, context) => options.success.call(context));
    spyOn(reviewReply, 'ready').and.callFake((options, context) => options.ready.call(context));
  });
  ...
  describe('Methods', function () {
    describe('save', function () {
      function testBodySave(options) {
        ...
        spyOn(reviewReply, 'save').and.callFake((options, context) => options.success.call(context));
        editor.save();
      ...
      function testCommentSave(options) {
        ...
        spyOn(editor, 'trigger');
        spyOn(options.model.prototype, 'ready').and.callFake((options, context) => options.ready.call(context));
        spyOn(options.model.prototype, 'save').and.callFake((options, context) => options.success.call(context));
        editor.save();
      ...
      it('With existing reply object', function () {
        ...
        spyOn(editor, 'trigger');
        spyOn(replyObject, 'ready').and.callFake((options, context) => options.ready.call(context));
        spyOn(replyObject, 'save').and.callFake((options, context) => options.success.call(context));
        editor.save();
        expect(editor.get('hasDraft')).toBe(true);
    ...
    describe('resetStateIfEmpty', function () {
      ...
      beforeEach(function () {
        ...
        spyOn(editor, 'trigger');
        spyOn(replyObject, 'destroy').and.callFake((options, context) => options.success.call(context));
      });
