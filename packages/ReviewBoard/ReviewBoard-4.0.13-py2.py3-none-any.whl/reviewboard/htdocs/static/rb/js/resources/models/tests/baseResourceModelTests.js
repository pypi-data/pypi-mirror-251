...
suite('rb/resources/models/BaseResource', function () {
  ...
  describe('ensureCreated', function () {
    ...
    describe('Callback handling', function () {
      beforeEach(function () {
        ...
        spyOn(model, 'save').and.callFake(options => {
    ...
    describe('Callback handling', function () {
      ...
      describe('With isNew=false and parentObject', function () {
        beforeEach(function () {
          ...
          spyOn(parentObject, 'ready').and.callFake((options, context) => {
  ...
  describe('ready', function () {
    ...
    beforeEach(function () {
      ...
      spyOn(model, 'fetch').and.callFake(options => options.success());
  ...
  describe('save', function () {
    ...
    describe('Callback handling', function () {
      ...
      describe('With isNew=true and parentObject', function () {
        ...
        beforeEach(function () {
          spyOn(parentObject, 'ensureCreated').and.callFake(options => {
            if (options && _.isFunction(options.success)) {
              options.success();
            }
          });
      ...
      describe('With isNew=false and parentObject', function () {
        beforeEach(function () {
          ...
          spyOn(parentObject, 'ready').and.callFake((options, context) => options.ready.call(context));
          spyOn(RB, 'apiCall').and.callThrough();
          spyOn($, 'ajax').and.callFake(request => {
    ...
    describe('Request payload', function () {
      it('Saved data', function () {
        ...
        spyOn(model, 'ready').and.callFake((options, context) => options.ready.call(context));
        spyOn(RB, 'apiCall').and.callThrough();
        spyOn($, 'ajax').and.callFake(request => {
