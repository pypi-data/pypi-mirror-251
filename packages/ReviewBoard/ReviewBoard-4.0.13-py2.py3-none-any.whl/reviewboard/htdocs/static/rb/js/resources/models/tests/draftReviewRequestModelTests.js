...
suite('rb/resources/models/DraftReviewRequest', function () {
  ...
  beforeEach(function () {
    ...
    spyOn(reviewRequest, 'ready').and.callFake((options, context) => options.ready.call(context));
    spyOn(reviewRequest, 'ensureCreated').and.callFake((options, context) => options.success.call(context));
    spyOn(draft, 'ready').and.callFake((options, context) => options.ready.call(context));
  });
  it('url', function () {
