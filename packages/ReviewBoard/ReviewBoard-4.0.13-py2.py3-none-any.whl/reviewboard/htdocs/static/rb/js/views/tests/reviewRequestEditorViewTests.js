...
'</div>`);
  ...
  beforeEach(function () {
    ...
    spyOn(reviewRequest.draft, 'ready').and.callFake((options, context) => options.ready.call(context));
  });
  afterEach(function () {
    ...
    describe('Draft banner', function () {
      describe('Visibility', function () {
        ...
        it('Show when saved', function () {
          ...
          expect(view.banner).toBe(null);
          spyOn(reviewRequest.draft, 'ensureCreated').and.callFake((options, context) => options.success.call(context));
          spyOn(reviewRequest.draft, 'save').and.callFake((options, context) => options.success.call(context));
      ...
      describe('Buttons actions', function () {
        ...
        it('Discard Review Request', function () {
          ...
          view.model.set('hasDraft', true);
          view.showBanner();
          spyOn(reviewRequest, 'close').and.callFake(options => expect(options.type).toBe(RB.ReviewRequest.CLOSE_DISCARDED));
      ...
      describe('endEdit', function () {
        describe('Decrement edit count', function () {
          ...
          it('On submit', function () {
            spyOn(fileAttachment, 'ready').and.callFake((options, context) => options.ready.call(context));
    ...
    describe('Events', function () {
      ...
      describe('endEdit', function () {
        describe('Decrement edit count', function () {
          ...
          it('On submit', function () {
            spyOn(screenshot, 'ready').and.callFake((options, context) => options.ready.call(context));
