...
suite('rb/ui/views/DateTimeInlineEditorView', function () {
  ...
  describe('Construction', function () {
    it('Default', function () {
      ...
      expect(field.firstElementChild.outerHTML).toBe('<input type="datetime-local">');
    });
    it('With options provided', function () {
      ...
      expect(view.$field.length).toBe(1);
      const field = view.$field[0];
      expect(field.firstElementChild.outerHTML).toBe(`<input type="datetime-local" max="2030-11-12T:06:30" \
...
//# sourceMappingURL=dateTimeInlineEditorViewTests.js.map