...
(function () {
  ...
  RB.ImageReviewableView = RB.FileAttachmentReviewableView.extend({
    ...
    renderContent() {
      ...
      const $resolutionMenu = $(['<li class="image-resolution-menu has-menu">', ' <a href="#" class="menu-header">', '  <span class="fa fa-search-plus"></span>', '  <span class="image-resolution-menu-current">100%</span>', '  <span class="rb-icon rb-icon-dropdown-arrow">', ' </a>', ' <ul class="menu"></ul>', '</li>'].join(''));
