...
# from care_query_status import CQStatus
...
class CareQueryData:
    ...
    def __init__(self, query, features, show = None):
        ...
        self.sftpmap = {
            ...
            'summus.com':'summus-user',
            'automationandinsight.com': 'lob-user'
        }
    ...
    def queryStatus(self):
        ...
        self.status = cqs.getStatus(user = self.token, query = self.query_id)

        return f"Query Status: {self.status}"

    def sftpToPandas(self, hostname = None, sftp_key = None, sftp_path = None):
