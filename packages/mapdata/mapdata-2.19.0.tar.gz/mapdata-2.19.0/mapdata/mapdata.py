...
class BivarStatsDialog(object):
	def __init__(self, parent, column_specs):
		...
		prompt_frame.grid(row=0, column=0, sticky=tk.N+tk.EW, pady=(3,3))
		prompt_frame.columnconfigure(0, weight=1)
		msg_lbl = ttk.Label(prompt_frame, width=70, text="Select two numerical variables.")
		msg_lbl.grid(row=0, column=0, sticky=tk.W, padx=(6,6), pady=(3,3))
		def wrap_msg(event):
			msg_lbl.configure(wraplength=event.width - 5)
		msg_lbl.bind("<Configure>", wrap_msg)
		...
		self.x_sel = ttk.Combobox(ctrl_frame, state="normal", textvariable=self.x_var, values=self.numeric_columns, width=24)
...
class HelpHotkeysDialog(object):
	def __init__(self):
		...
		ttk.Label(keyframe, width=50, justify=tk.LEFT, wraplength=350, text="Save the data table shown by the plot dialog and the statistics dialogs.").grid(row=0, column=1)
		...
		ttk.Label(keyframe, width=10, text="Alt-R").grid(row=6, column=0, sticky=tk.N+tk.W)
		ttk.Label(keyframe, width=50, justify=tk.LEFT, wraplength=350, text="For line plots and scatter plots: toggle the display of an ordinary least-squares linear regression line. For box plots, min-max plots, stripcharts and violin plots: rotate the X and Y axes.").grid(row=6, column=1)
		ttk.Label(keyframe, width=10, text="Alt-T").grid(row=7, column=0, sticky=tk.N+tk.W)
		ttk.Label(keyframe, width=50, justify=tk.LEFT, wraplength=350, text="Add or change the plot title.").grid(row=7, column=1)
		ttk.Label(keyframe, width=10, text="Alt-X").grid(row=8, column=0, sticky=tk.N+tk.W)
		ttk.Label(keyframe, width=50, justify=tk.LEFT, wraplength=350, text="Change the label on the plot's X axis.").grid(row=8, column=1)
		ttk.Label(keyframe, width=10, text="Alt-Y").grid(row=9, column=0, sticky=tk.N+tk.W)
		ttk.Label(keyframe, width=50, justify=tk.LEFT, wraplength=350, text="Change the label on the plot's Y axis.").grid(row=9, column=1)
