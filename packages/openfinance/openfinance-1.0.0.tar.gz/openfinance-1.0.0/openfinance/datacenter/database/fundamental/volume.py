...
def get_market_volume(name="China", entity_type=EntityEnum.Company.type, **kwargs: Any):
    ...
    data = {
        ...
        #"Monthly Small Company Trading Volume": get_factor_process("macd", Small_Company_Volume_Monthly),
        "MACD of Weekly Trading Volume": get_factor_process("macd", Big_Company_Volume_Weekly),
        #"Weekly Small Company Trading Volume": get_factor_process("macd", Small_Company_Volume_Weekly)
    }
    ...
    chart = ChartManager().get("line")(
        ...
        {"x": "DATE", "y": [
            ...
            #"Monthly Small Company Volume",
            "MACD of Weekly Trading Volume",
            #"Weekly Small Company Volume"
