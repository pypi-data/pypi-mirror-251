from .Functions import clear_table_widget, stretch_table_widget_colums_size, string_not_none, none_if_empty_string, boolean_not_none, none_if_false, list_widget_contains_item, get_sender_table_row, get_logical_table_row_list, check_optional_module, get_requests_response, is_flatpak
...
class MainWindow(Ui_MainWindow, QMainWindow):
    ...
    def __init__(self, env: Environment) -> None:
        ...
        self._preview_dialog = PreviewDialog(env)
        ...
        self.edit_only_show_in_widget = ListEditWidget(self, QCoreApplication.translate("MainWindow", "If set, the Application is only visble when using this Desktop Environments"))
        self.edit_not_show_in_widget = ListEditWidget(self, QCoreApplication.translate("MainWindow", "The Application is not visble when using this Desktop Environments"))
    ...
    def _browse_try_exec_button_clicked(self) -> None:
        ...
        self.try_exec_edit.setText(path)
