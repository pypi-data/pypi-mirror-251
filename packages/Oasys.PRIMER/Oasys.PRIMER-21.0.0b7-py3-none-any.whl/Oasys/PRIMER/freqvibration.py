...
class FreqVibration(Oasys.gRPC.OasysItem, metaclass=FreqVibrationType):
    _props = {'dampf', 'dmpmas', 'dmpstf', 'dmptyp', 'exists', 'fnmax', 'fnmin', 'icoarse', 'include', 'inftg', 'ipanelu', 'ipanelv', 'label', 'lcdam', 'lctyp', 'ldflag', 'ldtyp', 'mdmax', 'mdmin', 'method', 'mftg', 'napsd', 'ncpsd', 'nftg', 'option', 'restrm', 'restrt', 'strsf', 'strtyp', 'tcoarse', 'temper', 'texpos', 'umlt', 'unit', 'vaflag', 'vapsd', 'varms'}
    _rprops = {'model'}
