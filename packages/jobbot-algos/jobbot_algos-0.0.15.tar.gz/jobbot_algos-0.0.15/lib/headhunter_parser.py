...
class HeadHunterParser:
    ...
    def __init__(self, ssh_username:str, ssh_password:str, postgres_username:str, postgres_password:str):
        ...
        logger.info(f'ssh_username: {ssh_username}, ssh_password: {ssh_password}, postgres_username: {postgres_username}, postgres_password: {postgres_password}')
...
# %%time
# data = hh.run(professional_role=165, area=1, save_to_postgres=True)
