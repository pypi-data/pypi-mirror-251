...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        for val in self.data:
            data_dict[val] = data_dict.get(val, 0) + 1
        x_axis = data_dict.keys()
        y_axis = data_dict.values()
    ...
    def pdf(self, k):
        ...
        x1 = math.factorial(self.n)/(math.factorial(k)*(math.factorial(self.n - k)))
    ...
    def plot_bar_pdf(self):
        ...
        plt.title("Outcome Density Distribution")
        return x, y
