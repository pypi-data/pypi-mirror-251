...
def main():
    ...
    if subcommand == "enrich_rna":
        ...
        try:
            ...
            sys.exit( "MemoryError occurred.")
    elif subcommand == "enrich_multiome2":
        pass
...
def add_enrich_parser( subparsers ):
    ...
    """
    argparser_enrich = subparsers.add_parser("enrich_rna", help="Calculate TF activation use scRNA-seq data")
    ...
    group_output.add_argument( "-p", "--project", dest = "project", type = str, default = "" ,required = True,
                               help = 'Project name, which will be used to generate output files folder.')
...
def add_enrich_parser_multiome( subparsers ):
    """Add main function 'enrich' argument parsers.
    """
    argparser_enrich = subparsers.add_parser("enrich_multiome", help="Calculate TF activation use scRNA-seq data and scATAC-seq data")
...
def add_get_target_parser( subparsers ):
    """Add main function 'enrich' argument parsers.
    """
    argparser_enrich = subparsers.add_parser("get_target", help="Calculate TF and target gene score")
